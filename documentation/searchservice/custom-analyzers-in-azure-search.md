...
> [!NOTE]
> It's required that you configure you custom analyzer not to produce tokens longer than 300 character. Indexing will fail for documents with such tokens. To trim them or ignore them use TruncateTokenFilter or LengthTokenFilter respectively.
