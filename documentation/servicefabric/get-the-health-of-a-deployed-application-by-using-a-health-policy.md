---
title: "Get the health of a deployed application by using a health policy"
ms.custom: ""
ms.date: "2016-03-30"
ms.prod: "azure"
ms.reviewer: ""
...
ms.assetid: cea2dca6-c98f-49be-8fb8-c976c044684f
...
translation.priority.mt: 
  ...
  - "zh-tw"
---
# Get the health of a deployed application by using a health policy
Gets the health of a deployed Azure Service Fabric application, by using the specified health policy.  
  
## Request  
 See [Common parameters and headers](../ServiceFabricREST/deployed-application.md#bk_common) for headers and parameters that are used by all requests related to applications.  
  
|Method|Request URI|  
|------------|-----------------|  
|POST|The following URI can be used to evaluate the health of a deployed application:<br /><br /> `<URI>/Nodes/{node-name}/$/GetApplications/{application-name}/$/GetHealth?api-version={api-version}`|  
|POST|The following URI can be used to evaluate the health of a deployed application with events and deployed service packages filters:<br /><br /> `<URI>/Nodes/{node-name}/$/GetApplications/{application-name}/$/GetHealth?api-version={api-version}&EventsHealthStateFilter={EventsHealthStateFilter}& DeployedServicePackagesHealthStateFilter={DeployedServicePackagesHealthStateFilter}`|  
