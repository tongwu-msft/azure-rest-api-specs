---
title: "Report the health of a service&#160;"
ms.custom: ""
ms.date: "2016-03-30"
ms.prod: "azure"
ms.reviewer: ""
...
ms.assetid: d8f4a27b-0376-4921-a2de-a0b656355326
...
|Method|Request URI|  
|------------|-----------------|  
|POST|`<URI>/Applications/{application-name}/$/GetServices/{service-name}/$/ReportHealth?api-version=1.0`|  
|POST|`<URI>/Services/{service-name}/$/ReportHealth?api-version=1.0`|  
...
{  
    ...
    "Property": "State",  
    "HealthState": 3,  
    "Description": "Sample health state description of service health.",  
...
public static bool ReportServiceHealth(Uri clusterUri)  
{  
    ...
    Uri requestUri = new Uri(clusterUri, string.Format("/Applications/{0}/$/GetServices/{1}/$/ReportHealth?api-version={2}",  
    ...
    {  
        ...
        Console.WriteLine("Error reporting service health:");  
    ...
    Console.WriteLine("Report Service Health response status = " + statusCode.ToString());  
    return true;  
}  
  
/* This code produces output similar to the following:  
  
Report Service Health response status = OK  
*/  
