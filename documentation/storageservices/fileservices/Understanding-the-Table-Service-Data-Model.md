...
|`Edm.String`|`String`|A UTF-16-encoded value. String values may be up to 64 KB in size.|  
 ...
 By default a property is created as type `String`, unless you specify a different type. To explicitly type a property, specify its data type by using the appropriate OData data type for an [Insert Entity](../fileservices/Insert-Entity.md) or [Update Entity](../fileservices/Update-Entity2.md) operation. For more information, see [Inserting and Updating Entities](../fileservices/Inserting-and-Updating-Entities.md).  
  
 For examples that show how to filter on the various property types in a query request URI, see [Querying Tables and Entities](../fileservices/Querying-Tables-and-Entities.md).  
