...
```  
 ...
 An individual message may be updated or deleted by referring to the message ID. Note that this syntax is available only to the [Update Message](../fileservices/Update-Message.md) and [Delete Message](../fileservices/Delete-Message2.md) operation and requires a `popreceipt` parameter for verification:  
