...
|--------------------|-------------------------------------------|  
|[List Directories and Files](../fileservices/List-Directories-and-Files.md)|N/A.|  
|[Create File](../fileservices/Create-File.md)|Write, Delete.|  
|[Get File](../fileservices/Get-File.md)|Read.|  
|[Set File Properties](../fileservices/Set-File-Properties.md)|Write.|  
|[Get File Properties](../fileservices/Get-File-Properties.md)|N/A.|  
|[Set File Metadata](../fileservices/Set-File-Metadata.md)|Write.|  
|[Get File Metadata](../fileservices/Get-File-Metadata.md)|N/A.|  
|[Delete File](../fileservices/Delete-File2.md)|Delete.|  
|[Put Range](../fileservices/Put-Range.md)|Write.|  
|[List Ranges](../fileservices/List-Ranges.md)|Read.|  
  
 [List Directories and Files](../fileservices/List-Directories-and-Files.md), [Get File Properties](../fileservices/Get-File-Properties.md), and [Get File Metadata](../fileservices/Get-File-Metadata.md) do not operate on file content and do not require read access to the file (*i.e.*, these operations will still succeed even if an SMB client has the file open for exclusive read access).  
...
-   **REST Get File Sharing Violation**  
    ...
    -   The REST Client then performs a [Get File](../fileservices/Get-File.md) operation on the file (thereby using FileAccess.Read as specified in the table above).  
...
-   **REST Put Range Sharing Violation**  
    ...
    -   The REST Client then performs a [Put Range](../fileservices/Put-Range.md) operation on the file (thereby using FileAccess.Write as specified in the table above).  
...
|`Shared Read/Write/Delete`<br /><br /> `(Deny Nothing)`|Delete File|  
 ...
 The File service will return sharing violations only when files are open on SMB clients. Note that for a File service [Delete File](../fileservices/Delete-File2.md) operation to succeed, there can be no SMB clients with handles open against that file. Please refer to the [Delete File](../fileservices/Delete-File2.md) operation and the section below titled **Interaction between the File Service and SMB Opportunistic Locks** for more details.  
