...
### Request Body  
 The `Insert Entity` operation sends the entity to be inserted as an OData entity, which is either a JSON or an Atom feed. For more information, see [Inserting and Updating Entities](../fileservices/Inserting-and-Updating-Entities.md).  
...
## Remarks  
 ...
 For information about performing batch insert operations, see [Performing Entity Group Transactions](../fileservices/Performing-Entity-Group-Transactions.md).  
