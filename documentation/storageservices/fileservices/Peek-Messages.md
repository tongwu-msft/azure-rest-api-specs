...
```  
 ...
 Note that this response differs from the response for the [Get Messages](../fileservices/Get-Messages.md) operation in that the response does not contain the `PopReceipt` or `TimeNextVisible` elements.  
