...
# Querying DocumentDB resources using the REST API
  This section describes how to use REST to query DocumentDB resources. 
...
|--------------|-----------------|  
|query|**Required**. The SQL query string for the query. For more information see [DocumentDB SQL Query Language](DocumentDB%20SQL%20Query%20Language.md).|  
