...
#### Response Body  
 The response body depends on your linked service type, this example we are using Azure storage linked service, for more information about linked services, see [Linked Services](/azure/data-factory/connector-azure-blob-storage#azure-storage-linked-service).
...
#### Response Body  
 The structure of property depends on the type of linked service, for more information about linked services, see [Linked Services](/azure/data-factory/connector-azure-blob-storage#azure-storage-linked-service).
