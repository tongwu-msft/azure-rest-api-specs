...
This operations gets a inbound NAT rule on a load balancer.
...
|Method|Request URI|  
|------------|-----------------|  
|GET|`/subscriptions/subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/inboundNatRules/{ruleName}?api-version={api-version}`|  
