...
|autoScaleFormula|The formula that governs automatic scaling for the pool, if any. For more information about autoscale formulas, see [Automatically scale compute nodes in an Azure Batch pool](https://azure.microsoft.com/en-us/documentation/articles/batch-automatic-scaling/).|
