...
- **[Breaking]** Removed `osDisk` property from [`VirtualMachineConfiguration`](rest/api/batchservice/pool/add#virtualmachineconfiguration). This property is no longer supported.
