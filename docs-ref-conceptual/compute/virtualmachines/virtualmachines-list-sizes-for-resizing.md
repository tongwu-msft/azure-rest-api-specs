---
title: "List available virtual machine sizes for resizing"
author: davidmu1
ms.date: 2017-02-06
ms.prod: azure
...
| Method | Request URI |    
|--------|-------------|    
| GET | `https://management.azure.com/subscriptions/{subscriptionId}/providers/Microsoft.Compute/virtualMachines/{vm}/vmSizes?api-version={apiVersion}` | 
...
| maxDataDiskCount | Specifies the maximum number of data disks that can be attached to the virtual machine size. |