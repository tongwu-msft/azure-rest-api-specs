...
description: Reference documentation for the Azure API Management REST API 'Group' entity that describes how entity groups are used to manage the visibility of products to developers.
ms.custom: na
ms.date: 05/09/2016
ms.reviewer: na
