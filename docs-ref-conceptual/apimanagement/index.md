...
| [Subscriptions](~/docs-ref-autogen/apimanagement/Subscription.yml)                                  | Provides operations for managing product subscriptions.                                                                   |
| [Tag Description](~/docs-ref-autogen/apimanagement/TagDescription.yml)                               | Provides operations at the root level tenant, such as access key generation.  
| [Tenant Entity](~/docs-ref-autogen/apimanagement/Tag entity.yml)                                   | Provides operations for managing the Description of Tags.                                                                  |
| [Tenant Resource](~/docs-ref-autogen/apimanagement/TagResource.yml)                                   | Provides operations for managing the Tag entity associated with Apis, Products, Operations.                             |
| [Tenant Access](~/docs-ref-autogen/apimanagement/TenantAccess.yml)                                   | List the collection of resources associated with tags.                                                                   |
