...
| [API Operation](xref:management.azure.com.apimanagement.2019-12-01.apioperation)                               | Lists the operations for for an API.                                                                                           |
...
| [Gateway Hostnameconfiguration](xref:management.azure.com.apimanagement.2019-12-01.gatewayhostnameconfiguration)                      | Provides operations for managing gateway hostname configuration.      |
...
| [Sign In Settings](xref:management.azure.com.apimanagement.2019-12-01.signinsettings)                          | Provides operations for managing the SignIn settings on Developer Portal for a service instance.                               |
| [Sign Up Settings](xref:management.azure.com.apimanagement.2019-12-01.signupsettings)                          | Provides operations for managing the SignUp settings on Developer Portal for a service instance.                               |
