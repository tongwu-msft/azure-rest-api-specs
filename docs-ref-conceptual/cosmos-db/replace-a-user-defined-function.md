...
description: Learn how to replace a user defined function's properties by using a REST API request, the request and response object formats for this operation. 
ms.date: "02/25/2016"
