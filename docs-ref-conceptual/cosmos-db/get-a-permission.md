...
description: Get a permission REST API syntax. Request and response headers, body, status codes and examples.
ms.date: "02/25/2016"
...
|--------------|-----------------|  
|**id**|It is the unique name to identify a permission, that is, no two permissions owned by a user can share the same id. The **id** must not exceed 255 characters|  
