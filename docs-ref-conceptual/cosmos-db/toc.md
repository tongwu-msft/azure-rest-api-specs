# [Introduction](restful-interactions-with-cosmosdb-resources.md)
# [URIs](cosmosdb-resource-uri-syntax-for-rest.md)
# [Operations](common-tasks-using-the-cosmosdb-rest-api.md)
# [Status Codes](http-status-codes-for-cosmosdb.md)
# [Request headers](common-cosmosdb-rest-request-headers.md)
# [Response headers](common-cosmosdb-rest-response-headers.md)
# [Access control](access-control-on-cosmosdb-resources.md)
# [Querying resources](querying-cosmosdb-resources-using-the-rest-api.md)
...
## [Get partition key ranges for a Collection](get-partition-key-ranges.md)
