...
ms.tgt_pltfrm: ""
ms.topic: "reference"
ms.assetid: 5a3c4c20-5696-4892-a08e-59100ce825f1
...
* [Query Databases](querying-cosmosdb-resources-using-the-rest-api.md)  
...
* [Query Attachments](querying-cosmosdb-resources-using-the-rest-api.md)
...
* [Get Collection Partition Key Ranges](get-partition-key-ranges.md)  
* [Query Collections](querying-cosmosdb-resources-using-the-rest-api.md)
...
* [Query Stored Procedures](querying-cosmosdb-resources-using-the-rest-api.md) 
...
* [Query User Defined Functions](querying-cosmosdb-resources-using-the-rest-api.md)
...
* [Query Triggers](querying-cosmosdb-resources-using-the-rest-api.md)
...
* [Query Users](querying-cosmosdb-resources-using-the-rest-api.md)
...
* [Query Permissions](querying-cosmosdb-resources-using-the-rest-api.md)
