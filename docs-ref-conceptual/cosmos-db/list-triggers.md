...
description: List triggers REST API syntax. Request and response headers, body, status codes and examples.
ms.date: "02/25/2016"
...
|**Triggers**||  
|**id**|It is the unique name used to identify the trigger.|  
|**body**|It is the body of the trigger.|  
