---
title: Set Queue Service Properties (REST API) - Azure Storage
description: The Set Queue Service Properties operation sets properties for a storage account’s Queue service endpoint.
author: pemari-msft
...
## See Also  
 [Improved HTTP Headers for Resume on Download and a Change in If-Match Conditions](https://blogs.msdn.com.com/b/windowsazurestorage/archive/2011/09/15/windows-azure-blobs-improved-http-headers-for-resume-on-download-and-a-change-in-if-match-conditions.aspx)   
