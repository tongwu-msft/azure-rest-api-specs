...
|`x-ms-version`|Indicates the Azure Queue version that's used to execute the request. This header is returned for requests made against versions 2009-09-19 and later.|  
