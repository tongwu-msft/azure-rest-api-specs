...
|`x-ms-access-tier`|Version 2017-04-17 and newer. For page blobs on a premium account only. Specifies the tier to be set on the target blob. Check [High-performance Premium Storage and managed disks for VMs](/azure/storage/storage-premium-storage) for a full list of supported tiers. |
