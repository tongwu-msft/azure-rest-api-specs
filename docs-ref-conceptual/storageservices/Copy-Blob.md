...
|`x-ms-tags`|Optional. Sets the given query-string encoded tags on the blob. Tags are not copied from the copy source. See the Remarks for additional information. Supported in version 2020-12-12 and newer.|  
