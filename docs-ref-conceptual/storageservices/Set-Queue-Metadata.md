---
title: Set Queue Metadata (REST API) - Azure Storage
description: The Set Queue Metadata operation sets user-defined metadata on the specified queue. Metadata is associated with the queue as name-value pairs.
author: pemari-msft
