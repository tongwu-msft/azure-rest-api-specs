...
This field is supported with version 2020-12-06 or later. If the `ses` is added pior the supported version, the service returns error response code 403 (Forbidden).
