...
|`x-ms-immutability-policy-until-date`|Version 2020-06-12 or newer.  The immutability policy until date, returned if an immutability policy is set on the blob.  The value of this header is with RFC1123 format.| 
