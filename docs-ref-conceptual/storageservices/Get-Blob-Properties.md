...
|`x-ms-access-tier`|Version 2017-04-17 and newer. The tier of the blob on a premium storage account. For a list of allowed tiers, see [High-performance Premium Storage and managed disks for VMs](/azure/storage/storage-premium-storage#features). |  
