...
A user delegation SAS is supported for Azure blob store and Azure data lake store services. Stored access policies are not supported for a user delegation SAS.
