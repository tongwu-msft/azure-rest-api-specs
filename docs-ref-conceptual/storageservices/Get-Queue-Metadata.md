---
title: Get Queue Metadata (REST API) - Azure Storage
description: The Get Queue Metadata operation retrieves user-defined metadata and queue properties on the specified queue.
author: pemari-msft
