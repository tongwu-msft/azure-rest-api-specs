...
|`x-ms-meta-name:value`|Optional. User-defined name-value pairs associated with the blob.<br /><br /> Beginning with version 2009-09-19, metadata names must adhere to the naming rules for [C# identifiers](/dotnet/csharp/language-reference).|  
