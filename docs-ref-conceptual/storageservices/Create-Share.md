...
|`x-ms-enabled-protocols: <SMB | NFS>`|Optional. Supported in version 2020-02-10 and above. Specifies the enabled protocols on the share. If not specified, the default is SMB.<br /><br /><ul><li>`SMB`: The share can be accessed by SMBv3.0, SMBv2.1 and REST.</li><li>`NFS`: The share can be accessed by NFSv4.1. A premium account is required for this option.</li></ul>|  
