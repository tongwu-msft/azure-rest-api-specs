...
### [Set Immutability Policy](set-blob-immutability-policy-x.md)
### [Delete Immutability Policy](delete-blob-immutability-policy-x.md)
### [Set Legal Hold](set-blob-legal-hold-x.md)
