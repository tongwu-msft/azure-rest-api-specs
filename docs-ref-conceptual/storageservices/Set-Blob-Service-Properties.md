...
|**RetentionPolicy/AllowPermanentDelete**|Optional, version 2020-04-08 and later.  Allows you to enable permanent delete on the storage account.  Default is `false.`|
