 ...
 *TThe preceding trace message shows that the response has been received and its http status code.*   
 ...
 *The preceding trace message shows that 8 results were retrieved and no continuation token was provided meaning no more results exist for this query.*   
