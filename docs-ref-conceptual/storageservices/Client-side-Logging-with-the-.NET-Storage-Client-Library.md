---
title: Client-side logging with the client library for .NET (REST) - Azure Storage
description: The Storage Client Library enables you to log Azure Storage requests client-side from within your .NET client application using the standard .NET diagnostics infrastructure.
author: pemari-msft
