...
-   Only REST operations using version 2014-02-14 and later are supported for Premium Storage. See [Versioning for the Azure Storage Services](../fileservices/Versioning-for-the-Azure-Storage-Services.md) for details.  
  
-   The number of snapshots per page blob in a Premium Storage account is limited to 100. If that limit is exceeded, the [Snapshot Blob](../fileservices/Snapshot-Blob.md) operation returns error code 409 (SnapshotCountExceeded).  
...
-   Public access to a container containing page blobs in Premium Storage is not permitted. Calling [Set Container ACL](../fileservices/Set-Container-ACL.md) with the `x-ms-blob-public-access` header returns error code 400 (UnsupportedHeader).  
  
 For additional error information, see [Blob Service Error Codes](../fileservices/Blob-Service-Error-Codes.md).  
...
|--------------------|----------------------------------------------|  
|Read operations|[Get Blob](../fileservices/Get-Blob.md)<br /><br /> [Get Page Ranges](../fileservices/Get-Page-Ranges.md)|  
|Write operations|[Put Blob](../fileservices/Put-Blob.md)<br /><br /> [Put Page](../fileservices/Put-Page.md)<br /><br /> [Set Blob Properties](../fileservices/Set-Blob-Properties.md)<br /><br /> [Set Blob Metadata](../fileservices/Set-Blob-Metadata.md)|  
|Delete operations|[Delete Blob](../fileservices/Delete-Blob.md)|  
|Lease operations|[Lease Blob](../fileservices/Lease-Blob.md)|  
