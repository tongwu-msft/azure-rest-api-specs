...
>  Storage accounts with a replication type of Zone-Redundant Storage (ZRS) do not have the metrics or logging capability enabled at this time.  
 ...
 For information about how to enable and view Storage Metrics data, see the topic [Enabling Storage Metrics and Viewing Metrics Data](../fileservices/Enabling-Storage-Metrics-and-Viewing-Metrics-Data.md).  
  
 For information about how to enable and access Storage Logging data, see the topic [Enabling Storage Logging and Accessing Log Data](../fileservices/Enabling-Storage-Logging-and-Accessing-Log-Data.md).  
