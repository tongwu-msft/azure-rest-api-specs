...
## Available Versions  
 The current version of the Azure storage services is [2018-11-09](version-2018-11-09.md), and using that version is recommended where possible. For information about the latest version, see [Versioning for the Azure Storage Services](Versioning-for-the-Azure-Storage-Services.md).  
