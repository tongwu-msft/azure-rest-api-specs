---
title: Get Queue Service Properties (REST API) - Azure Storage
description: The Get Queue Service Properties operation gets the properties of a storage account’s Queue service.
author: pemari-msft
...
|--------------------|-----------------|  
|`Authorization`|Required. Specifies the authorization scheme, storage account name, and signature. For more information, see [Authorization for the Azure Storage Services](authorization-for-the-azure-storage-services.md).|  
