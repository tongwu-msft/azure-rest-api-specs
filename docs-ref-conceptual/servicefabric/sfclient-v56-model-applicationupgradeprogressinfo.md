...
| [UpgradeDescription](#upgradedescription) | [ApplicationUpgradeDescription](sfclient-v56-model-applicationupgradedescription.md) | No |
...
| [UpgradeDomainProgressAtFailure](#upgradedomainprogressatfailure) | [FailureUpgradeDomainProgressInfo](sfclient-v56-model-failureupgradedomainprogressinfo.md) | No |
...
____
### UpgradeDescription
__Type__: [ApplicationUpgradeDescription](sfclient-v56-model-applicationupgradedescription.md) <br/>
__Required__: No<br/>
<br/>
...
__Type__: [FailureUpgradeDomainProgressInfo](sfclient-v56-model-failureupgradedomainprogressinfo.md) <br/>
__Required__: No<br/>
<br/>
