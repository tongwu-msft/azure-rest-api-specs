...
| [`Items`](#items) | array of [NodeHealthStateChunk](sfclient-v62-model-nodehealthstatechunk.md) | No |
...
____
### `Items`
__Type__: array of [NodeHealthStateChunk](sfclient-v62-model-nodehealthstatechunk.md) <br/>
__Required__: No<br/>
<br/>
