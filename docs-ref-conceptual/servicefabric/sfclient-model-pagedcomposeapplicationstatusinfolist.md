...
| [Items](#items) | array of [ComposeApplicationStatusInfo](sfclient-model-composeapplicationstatusinfo.md) | No |
...
____
### Items
__Type__: array of [ComposeApplicationStatusInfo](sfclient-model-composeapplicationstatusinfo.md) <br/>
__Required__: No<br/>
<br/>
