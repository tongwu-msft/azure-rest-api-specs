...
| [CodePackageEntryPointStatistics](#codepackageentrypointstatistics) | [CodePackageEntryPointStatistics](model-CodePackageEntryPointStatistics.md) | No |
...
__Type__: [CodePackageEntryPointStatistics](model-CodePackageEntryPointStatistics.md) <br/>
__Required__: No<br/>
<br/>
