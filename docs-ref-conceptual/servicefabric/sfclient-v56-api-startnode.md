...
| [StartNodeDescription](#startnodedescription) | [StartNodeDescription](sfclient-v56-model-startnodedescription.md) | Yes | Body |
...
__Type__: [StartNodeDescription](sfclient-v56-model-startnodedescription.md) <br/>
__Required__: Yes<br/>
<br/>
