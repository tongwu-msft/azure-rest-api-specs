---
title: "DeployedServiceHealthReportExpiredEvent"
ms.date: 04/23/2018
ms.prod: "azure"
...
| [`ServiceManifest`](#servicemanifest) | string | Yes |
...
| [`TTLTimespan`](#ttltimespan) | integer (int64) | Yes |
...
__Required__: Yes <br/>
<br/>
A discriminator property. Its value must be 'DeployedServiceHealthReportExpired' for objects of type 'DeployedServiceHealthReportExpiredEvent'.
