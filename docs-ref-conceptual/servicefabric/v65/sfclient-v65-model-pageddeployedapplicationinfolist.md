...
| [`Items`](#items) | array of [DeployedApplicationInfo](sfclient-v65-model-deployedapplicationinfo.md) | No |
...
____
### `Items`
__Type__: array of [DeployedApplicationInfo](sfclient-v65-model-deployedapplicationinfo.md) <br/>
__Required__: No<br/>
<br/>
