...
| [`PartitionInformation`](#partitioninformation) | [PartitionInformation](sfclient-v65-model-partitioninformation.md) | Yes |
| [`Endpoints`](#endpoints) | array of [ResolvedServiceEndpoint](sfclient-v65-model-resolvedserviceendpoint.md) | Yes |
...
__Type__: [PartitionInformation](sfclient-v65-model-partitioninformation.md) <br/>
__Required__: Yes<br/>
<br/>
...
____
### `Endpoints`
__Type__: array of [ResolvedServiceEndpoint](sfclient-v65-model-resolvedserviceendpoint.md) <br/>
__Required__: Yes<br/>
<br/>
