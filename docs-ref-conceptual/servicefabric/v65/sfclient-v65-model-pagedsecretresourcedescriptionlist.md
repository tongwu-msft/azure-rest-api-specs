...
| [`Items`](#items) | array of [SecretResourceDescription](sfclient-v65-model-secretresourcedescription.md) | No |
...
____
### `Items`
__Type__: array of [SecretResourceDescription](sfclient-v65-model-secretresourcedescription.md) <br/>
__Required__: No<br/>
<br/>
