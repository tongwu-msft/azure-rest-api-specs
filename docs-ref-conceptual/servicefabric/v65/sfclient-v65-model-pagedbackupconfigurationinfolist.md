...
| [`Items`](#items) | array of [BackupConfigurationInfo](sfclient-v65-model-backupconfigurationinfo.md) | No |
...
____
### `Items`
__Type__: array of [BackupConfigurationInfo](sfclient-v65-model-backupconfigurationinfo.md) <br/>
__Required__: No<br/>
<br/>
