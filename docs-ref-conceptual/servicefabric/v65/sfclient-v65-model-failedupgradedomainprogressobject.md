...
| [`NodeUpgradeProgressList`](#nodeupgradeprogresslist) | array of [NodeUpgradeProgressInfo](sfclient-v65-model-nodeupgradeprogressinfo.md) | No |
...
__Type__: array of [NodeUpgradeProgressInfo](sfclient-v65-model-nodeupgradeprogressinfo.md) <br/>
__Required__: No<br/>
<br/>
