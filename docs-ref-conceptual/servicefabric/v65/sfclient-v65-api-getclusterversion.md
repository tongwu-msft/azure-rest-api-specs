...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the requested cluster version information.<br/> | [ClusterVersion](sfclient-v65-model-clusterversion.md) |
...
This example retrieves the current (or lowest version during upgrade) cluster version.
