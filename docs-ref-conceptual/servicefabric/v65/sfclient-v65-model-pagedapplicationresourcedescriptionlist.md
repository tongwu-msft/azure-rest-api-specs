...
| [`Items`](#items) | array of [ApplicationResourceDescription](sfclient-v65-model-applicationresourcedescription.md) | No |
...
____
### `Items`
__Type__: array of [ApplicationResourceDescription](sfclient-v65-model-applicationresourcedescription.md) <br/>
__Required__: No<br/>
<br/>
