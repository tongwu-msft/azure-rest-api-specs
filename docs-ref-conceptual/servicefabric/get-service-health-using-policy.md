...
| Method | Request URI |
| ------ | ----------- |
| POST | `/Services/{serviceId}/$/GetHealth?api-version=3.0&EventsHealthStateFilter={EventsHealthStateFilter}&PartitionsHealthStateFilter={PartitionsHealthStateFilter}` |
...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the health information of the specified service.<br/> | [ServiceHealth](model-ServiceHealth.md) |
