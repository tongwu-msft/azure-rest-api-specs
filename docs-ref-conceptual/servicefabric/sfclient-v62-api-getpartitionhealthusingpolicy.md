...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the health information about the specified partition.<br/> | [PartitionHealth](sfclient-v62-model-partitionhealth.md) |
