...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the requested cluster version information.<br/> | [ClusterVersion](sfclient-model-clusterversion.md) |
