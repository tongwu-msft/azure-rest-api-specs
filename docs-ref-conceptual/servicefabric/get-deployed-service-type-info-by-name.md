...
| Method | Request URI |
| ------ | ----------- |
| GET | `/Nodes/{nodeName}/$/GetApplications/{applicationId}/$/GetServiceTypes/{serviceTypeName}?api-version=3.0&ServiceManifestName={ServiceManifestName}` |
...
| --- | --- | --- |
| 200 (OK) | Information about service types of an application deployed on a node.<br/> | [DeployedServiceTypeInfo](model-DeployedServiceTypeInfo.md) |
