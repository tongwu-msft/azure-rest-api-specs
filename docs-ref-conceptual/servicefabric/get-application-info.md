...
| Method | Request URI |
| ------ | ----------- |
| GET | `/Applications/{applicationId}?api-version=3.0&ExcludeApplicationParameters={ExcludeApplicationParameters}` |
...
| --- | --- | --- |
| 200 (OK) | Information about the application.<br/> | [ApplicationInfo](model-ApplicationInfo.md) |
