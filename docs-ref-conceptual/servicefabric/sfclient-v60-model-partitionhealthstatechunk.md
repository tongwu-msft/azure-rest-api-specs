...
| [ReplicaHealthStateChunks](#replicahealthstatechunks) | [ReplicaHealthStateChunkList](sfclient-v60-model-replicahealthstatechunklist.md) | No |
...
__Type__: [ReplicaHealthStateChunkList](sfclient-v60-model-replicahealthstatechunklist.md) <br/>
__Required__: No<br/>
<br/>
