...
| [`Items`](#items) | array of [LoadedPartitionInformationResult](sfclient-v80-model-loadedpartitioninformationresult.md) | No |
...
____
### `Items`
__Type__: array of [LoadedPartitionInformationResult](sfclient-v80-model-loadedpartitioninformationresult.md) <br/>
__Required__: No<br/>
<br/>
