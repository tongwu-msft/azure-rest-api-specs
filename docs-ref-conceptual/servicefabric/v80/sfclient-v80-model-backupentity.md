...
| --- | --- | 
| Application | [ApplicationBackupEntity](sfclient-v80-model-applicationbackupentity.md) |
| Service | [ServiceBackupEntity](sfclient-v80-model-servicebackupentity.md) |
| Partition | [PartitionBackupEntity](sfclient-v80-model-partitionbackupentity.md) |
