...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the requested cluster load information.<br/> | [ClusterLoadInfo](sfclient-v80-model-clusterloadinfo.md) |
