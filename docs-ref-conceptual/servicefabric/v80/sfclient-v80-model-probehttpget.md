...
| [`path`](#path) | string | No |
| [`host`](#host) | string | No |
| [`httpHeaders`](#httpheaders) | array of [ProbeHttpGetHeaders](sfclient-v80-model-probehttpgetheaders.md) | No |
...
____
### `httpHeaders`
__Type__: array of [ProbeHttpGetHeaders](sfclient-v80-model-probehttpgetheaders.md) <br/>
__Required__: No<br/>
<br/>
