...
| --- | --- | --- |
| 200 (OK) | Information about the specified partition's last reported load metrics.<br/> | [PartitionLoadInformation](sfclient-v80-model-partitionloadinformation.md) |
