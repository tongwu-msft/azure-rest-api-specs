...
| [`ApplicationLoadMetricInformation`](#applicationloadmetricinformation) | array of [ApplicationLoadMetricInformation](sfclient-v80-model-applicationloadmetricinformation.md) | No |
...
__Type__: array of [ApplicationLoadMetricInformation](sfclient-v80-model-applicationloadmetricinformation.md) <br/>
__Required__: No<br/>
<br/>
