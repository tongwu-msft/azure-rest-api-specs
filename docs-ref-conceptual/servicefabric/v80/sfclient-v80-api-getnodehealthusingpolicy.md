...
| [`ClusterHealthPolicy`](#clusterhealthpolicy) | [ClusterHealthPolicy](sfclient-v80-model-clusterhealthpolicy.md) | No | Body |
...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the requested node health information.<br/> | [NodeHealth](sfclient-v80-model-nodehealth.md) |
