...
| [`PropertyBatchDescriptionList`](#propertybatchdescriptionlist) | [PropertyBatchDescriptionList](sfclient-v80-model-propertybatchdescriptionlist.md) | Yes | Body |
...
__Type__: [PropertyBatchDescriptionList](sfclient-v80-model-propertybatchdescriptionlist.md) <br/>
__Required__: Yes<br/>
<br/>
...
| --- | --- | --- |
| 200 (OK) | A successful response means that the property batch succeeded.<br/> | [SuccessfulPropertyBatchInfo](sfclient-v80-model-successfulpropertybatchinfo.md) |
| 409 (Conflict) | A 409 response means that one of the property batch operations failed, and contains more information about the failure. None of the operations were committed.<br/> | [FailedPropertyBatchInfo](sfclient-v80-model-failedpropertybatchinfo.md) |
