...
| Method | Request URI |
| ------ | ----------- |
| GET | `/Services/{serviceId}/$/GetApplicationName?api-version=3.0` |
...
| --- | --- | --- |
| 200 (OK) | Information about the name of the application for the specified service.<br/> | [ApplicationNameInfo](model-ApplicationNameInfo.md) |
