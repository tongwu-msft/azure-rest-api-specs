---
title: "StatefulReplicaHealthReportCreatedEvent"
ms.date: "2018-04-23"
ms.prod: "azure"
...
| [`ReplicaInstanceId`](#replicainstanceid) | integer (int64) | Yes |
...
__Required__: Yes <br/>
<br/>
A discriminator property. Its value must be 'StatefulReplicaHealthReportCreated' for objects of type 'StatefulReplicaHealthReportCreatedEvent'.
