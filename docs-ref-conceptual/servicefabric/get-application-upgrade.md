...
| Method | Request URI |
| ------ | ----------- |
| GET | `/Applications/{applicationId}/$/GetUpgradeProgress?api-version=3.0` |
...
| --- | --- | --- |
| 200 (OK) | The application upgrade details.<br/> | [ApplicationUpgradeProgressInfo](model-ApplicationUpgradeProgressInfo.md) |
