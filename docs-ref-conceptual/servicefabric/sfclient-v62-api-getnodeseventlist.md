...
| Method | Request URI |
| ------ | ----------- |
| GET | `/EventsStore/Nodes/Events?api-version=6.2-preview&timeout={timeout}&StartTimeUtc={StartTimeUtc}&EndTimeUtc={EndTimeUtc}&EventsTypesFilter={EventsTypesFilter}&ExcludeAnalysisEvents={ExcludeAnalysisEvents}&SkipCorrelationLookup={SkipCorrelationLookup}` |
...
| --- | --- | --- |
| 200 (OK) | List of events objects with base type NodeEvent.<br/> | array of [NodeEvent](sfclient-v62-model-nodeevent.md) |
...
#### Request
```
GET http://localhost:19080/EventsStore/Nodes/Events?api-version=6.2-preview&StartTimeUtc=2018-04-03T18:00:00Z&EndTimeUtc=2018-04-04T18:00:00Z
```
