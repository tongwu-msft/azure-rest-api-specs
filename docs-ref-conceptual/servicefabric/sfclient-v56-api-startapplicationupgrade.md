...
| Method | Request URI |
| ------ | ----------- |
| POST | `/Applications/{applicationId}/$/Upgrade?api-version=3.0&timeout={timeout}` |
...
| [ApplicationUpgradeDescription](#applicationupgradedescription) | [ApplicationUpgradeDescription](sfclient-v56-model-applicationupgradedescription.md) | Yes | Body |
