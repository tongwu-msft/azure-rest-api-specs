...
| [ReplicaHealthStates](#replicahealthstates) | array of [ReplicaHealthState](model-ReplicaHealthState.md) | No |
...
____
### ReplicaHealthStates
__Type__: array of [ReplicaHealthState](model-ReplicaHealthState.md) <br/>
__Required__: No<br/>
<br/>
