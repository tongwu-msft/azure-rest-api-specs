...
| --- | --- | --- |
| 200 (OK) | Information about the specified partition's last reported load metrics.<br/> | [PartitionLoadInformation](sfclient-v60-model-partitionloadinformation.md) |
