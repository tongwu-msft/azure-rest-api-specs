...
| [Items](#items) | array of [NodeHealthStateChunk](sfclient-v56-model-nodehealthstatechunk.md) | No |
...
____
### Items
__Type__: array of [NodeHealthStateChunk](sfclient-v56-model-nodehealthstatechunk.md) <br/>
__Required__: No<br/>
<br/>
