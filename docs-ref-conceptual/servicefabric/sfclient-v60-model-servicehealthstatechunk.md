...
| [PartitionHealthStateChunks](#partitionhealthstatechunks) | [PartitionHealthStateChunkList](sfclient-v60-model-partitionhealthstatechunklist.md) | No |
...
__Type__: [PartitionHealthStateChunkList](sfclient-v60-model-partitionhealthstatechunklist.md) <br/>
__Required__: No<br/>
<br/>
