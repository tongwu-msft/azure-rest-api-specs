...
| --- | --- | --- |
| 200 (OK) | Information about service types of an application deployed on a node.<br/> | array of [DeployedServiceTypeInfo](sfclient-v64-model-deployedservicetypeinfo.md) |
