...
| Name | Type | Required |
| --- | --- | --- |
| [ChaosParameters](#chaosparameters) | [ChaosParameters](sfclient-v61-model-chaosparameters.md) | No |
| [Status](#status) | string (enum) | No |
| [ContinuationToken](#continuationtoken) | string | No |
| [History](#history) | array of [ChaosEventWrapper](sfclient-v61-model-chaoseventwrapper.md) | No |

____
### ChaosParameters
__Type__: [ChaosParameters](sfclient-v61-model-chaosparameters.md) <br/>
__Required__: No<br/>
<br/>
...
____
### History
__Type__: array of [ChaosEventWrapper](sfclient-v61-model-chaoseventwrapper.md) <br/>
__Required__: No<br/>
<br/>
