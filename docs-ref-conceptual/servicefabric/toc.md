...
### [Status enum](sfclient-model-status.md)
...
### [NodeStatusFilterOptionalQueryParam enum](sfclient-model-nodestatusfilteroptionalqueryparam.md)
### [ReplicaHealthReportServiceKindRequiredQueryParam enum](sfclient-model-replicahealthreportservicekindrequiredqueryparam.md)
### [DataLossModeRequiredQueryParam enum](sfclient-model-datalossmoderequiredqueryparam.md)
### [NodeTransitionTypeRequiredQueryParam enum](sfclient-model-nodetransitiontyperequiredqueryparam.md)
### [QuorumLossModeRequiredQueryParam enum](sfclient-model-quorumlossmoderequiredqueryparam.md)
### [RestartPartitionModeRequiredQueryParam enum](sfclient-model-restartpartitionmoderequiredqueryparam.md)
