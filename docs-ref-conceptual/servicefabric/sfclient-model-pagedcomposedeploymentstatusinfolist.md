...
description: "PagedComposeDeploymentStatusInfoList"
ms.date: "04/02/2021"
...
| [`Items`](#items) | array of [ComposeDeploymentStatusInfo](sfclient-model-composedeploymentstatusinfo.md) | No |
...
____
### `Items`
__Type__: array of [ComposeDeploymentStatusInfo](sfclient-model-composedeploymentstatusinfo.md) <br/>
__Required__: No<br/>
<br/>
