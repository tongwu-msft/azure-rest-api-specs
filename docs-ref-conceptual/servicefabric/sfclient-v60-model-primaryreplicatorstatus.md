...
| [RemoteReplicators](#remotereplicators) | array of [RemoteReplicatorStatus](sfclient-v60-model-remotereplicatorstatus.md) | No |
...
____
### RemoteReplicators
__Type__: array of [RemoteReplicatorStatus](sfclient-v60-model-remotereplicatorstatus.md) <br/>
__Required__: No<br/>
<br/>
