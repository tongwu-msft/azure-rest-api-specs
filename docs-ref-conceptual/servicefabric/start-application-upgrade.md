...
| Method | Request URI |
| ------ | ----------- |
| POST | `/Applications/{applicationId}/$/Upgrade?api-version=3.0` |
...
| [ApplicationUpgradeDescription](#applicationupgradedescription) | [ApplicationUpgradeDescription](model-ApplicationUpgradeDescription.md) | Yes | Body |
