...
| [`Items`](#items) | array of [UpdatePartitionLoadResult](sfclient-model-updatepartitionloadresult.md) | No |
...
____
### `Items`
__Type__: array of [UpdatePartitionLoadResult](sfclient-model-updatepartitionloadresult.md) <br/>
__Required__: No<br/>
<br/>
