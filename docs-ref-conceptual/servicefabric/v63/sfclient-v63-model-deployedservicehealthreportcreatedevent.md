---
title: "DeployedServiceHealthReportCreatedEvent"
ms.date: 07/20/2018
...
__Required__: Yes <br/>
<br/>
A discriminator property. Its value must be 'DeployedServiceHealthReportCreated' for objects of type 'DeployedServiceHealthReportCreatedEvent'.
