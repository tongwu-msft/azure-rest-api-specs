...
| [`Items`](#items) | array of [ServiceResourceReplicaDescription](sfclient-v63-model-serviceresourcereplicadescription.md) | No |
...
____
### `Items`
__Type__: array of [ServiceResourceReplicaDescription](sfclient-v63-model-serviceresourcereplicadescription.md) <br/>
__Required__: No<br/>
<br/>
