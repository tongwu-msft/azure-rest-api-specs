...
| [`Items`](#items) | array of [ServicePartitionInfo](sfclient-v62-model-servicepartitioninfo.md) | No |
...
____
### `Items`
__Type__: array of [ServicePartitionInfo](sfclient-v62-model-servicepartitioninfo.md) <br/>
__Required__: No<br/>
<br/>
