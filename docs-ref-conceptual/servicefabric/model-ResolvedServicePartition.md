...
| [PartitionInformation](#partitioninformation) | [PartitionInformation](model-PartitionInformation.md) | Yes |
| [Endpoints](#endpoints) | array of [ResolvedServiceEndpoint](model-ResolvedServiceEndpoint.md) | Yes |
...
____
### Endpoints
__Type__: array of [ResolvedServiceEndpoint](model-ResolvedServiceEndpoint.md) <br/>
__Required__: Yes<br/>
<br/>
