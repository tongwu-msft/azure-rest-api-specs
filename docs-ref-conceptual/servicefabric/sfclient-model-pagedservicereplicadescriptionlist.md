...
| [`Items`](#items) | array of [ServiceReplicaDescription](sfclient-model-servicereplicadescription.md) | No |
...
____
### `Items`
__Type__: array of [ServiceReplicaDescription](sfclient-model-servicereplicadescription.md) <br/>
__Required__: No<br/>
<br/>
