...
| [`ClusterHealthPolicies`](#clusterhealthpolicies) | [ClusterHealthPolicies](sfclient-v72-model-clusterhealthpolicies.md) | No | Body |
...
__Type__: [ClusterHealthPolicies](sfclient-v72-model-clusterhealthpolicies.md) <br/>
__Required__: No<br/>
<br/>
...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the requested cluster health information.<br/> | [ClusterHealth](sfclient-v72-model-clusterhealth.md) |
