...
| --- | --- | 
| Application | [ApplicationBackupEntity](sfclient-v72-model-applicationbackupentity.md) |
| Service | [ServiceBackupEntity](sfclient-v72-model-servicebackupentity.md) |
| Partition | [PartitionBackupEntity](sfclient-v72-model-partitionbackupentity.md) |
