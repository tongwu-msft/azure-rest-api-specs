...
| [`PartitionMetricLoadDescriptionList`](#partitionmetricloaddescriptionlist) | array of [PartitionMetricLoadDescription](sfclient-v72-model-partitionmetricloaddescription.md) | Yes | Body |
...
__Type__: array of [PartitionMetricLoadDescription](sfclient-v72-model-partitionmetricloaddescription.md) <br/>
__Required__: Yes<br/>
<br/>
...
| --- | --- | --- |
| 200 (OK) | List UpdatePartitionLoadResults.<br/> | [PagedUpdatePartitionLoadResultList](sfclient-v72-model-pagedupdatepartitionloadresultlist.md) |
| All other status codes | The error code response per specified partition.<br/> | [FabricError](sfclient-v72-model-fabricerror.md) |
