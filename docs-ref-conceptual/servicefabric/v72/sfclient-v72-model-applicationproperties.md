...
| [`services`](#services) | array of [ServiceResourceDescription](sfclient-v72-model-serviceresourcedescription.md) | No |
| [`diagnostics`](#diagnostics) | [DiagnosticsDescription](sfclient-v72-model-diagnosticsdescription.md) | No |
...
____
### `services`
__Type__: array of [ServiceResourceDescription](sfclient-v72-model-serviceresourcedescription.md) <br/>
__Required__: No<br/>
<br/>
...
____
### `diagnostics`
__Type__: [DiagnosticsDescription](sfclient-v72-model-diagnosticsdescription.md) <br/>
__Required__: No<br/>
<br/>
