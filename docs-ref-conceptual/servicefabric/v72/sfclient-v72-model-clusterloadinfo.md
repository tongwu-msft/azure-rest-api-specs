...
| [`LoadMetricInformation`](#loadmetricinformation) | array of [LoadMetricInformation](sfclient-v72-model-loadmetricinformation.md) | No |
...
__Type__: array of [LoadMetricInformation](sfclient-v72-model-loadmetricinformation.md) <br/>
__Required__: No<br/>
<br/>
