...
| [`Items`](#items) | array of [BackupConfigurationInfo](sfclient-v72-model-backupconfigurationinfo.md) | No |
...
____
### `Items`
__Type__: array of [BackupConfigurationInfo](sfclient-v72-model-backupconfigurationinfo.md) <br/>
__Required__: No<br/>
<br/>
