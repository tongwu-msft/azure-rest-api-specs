...
| [`Items`](#items) | array of [GatewayResourceDescription](sfclient-v72-model-gatewayresourcedescription.md) | No |
...
____
### `Items`
__Type__: array of [GatewayResourceDescription](sfclient-v72-model-gatewayresourcedescription.md) <br/>
__Required__: No<br/>
<br/>
