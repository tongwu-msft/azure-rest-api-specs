...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the requested application health information.<br/> | [ApplicationHealth](sfclient-v72-model-applicationhealth.md) |
