...
| [`Items`](#items) | array of [UpdatePartitionLoadResult](sfclient-v72-model-updatepartitionloadresult.md) | No |
...
____
### `Items`
__Type__: array of [UpdatePartitionLoadResult](sfclient-v72-model-updatepartitionloadresult.md) <br/>
__Required__: No<br/>
<br/>
