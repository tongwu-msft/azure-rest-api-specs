...
| [`Items`](#items) | array of [SecretResourceDescription](sfclient-v72-model-secretresourcedescription.md) | No |
...
____
### `Items`
__Type__: array of [SecretResourceDescription](sfclient-v72-model-secretresourcedescription.md) <br/>
__Required__: No<br/>
<br/>
