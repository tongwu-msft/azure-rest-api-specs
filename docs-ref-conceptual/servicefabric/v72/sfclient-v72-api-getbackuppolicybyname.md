...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the backup policy description.<br/> | [BackupPolicyDescription](sfclient-v72-model-backuppolicydescription.md) |
