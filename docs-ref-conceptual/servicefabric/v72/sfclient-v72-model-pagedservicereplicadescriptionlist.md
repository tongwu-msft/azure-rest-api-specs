...
| [`Items`](#items) | array of [ServiceReplicaDescription](sfclient-v72-model-servicereplicadescription.md) | No |
...
____
### `Items`
__Type__: array of [ServiceReplicaDescription](sfclient-v72-model-servicereplicadescription.md) <br/>
__Required__: No<br/>
<br/>
