...
| [`EpochOfLastBackupRecord`](#epochoflastbackuprecord) | [Epoch](sfclient-v72-model-epoch.md) | No |
| [`LsnOfLastBackupRecord`](#lsnoflastbackuprecord) | string | No |
| [`FailureError`](#failureerror) | [FabricErrorError](sfclient-v72-model-fabricerrorerror.md) | No |
...
____
### `FailureError`
__Type__: [FabricErrorError](sfclient-v72-model-fabricerrorerror.md) <br/>
__Required__: No<br/>
<br/>
