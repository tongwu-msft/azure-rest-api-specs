...
| [`UpgradeDomains`](#upgradedomains) | array of [UpgradeDomainInfo](sfclient-v72-model-upgradedomaininfo.md) | No |
...
| [`UpgradeDescription`](#upgradedescription) | [ClusterUpgradeDescriptionObject](sfclient-v72-model-clusterupgradedescriptionobject.md) | No |
...
| [`UnhealthyEvaluations`](#unhealthyevaluations) | array of [HealthEvaluationWrapper](sfclient-v72-model-healthevaluationwrapper.md) | No |
| [`CurrentUpgradeDomainProgress`](#currentupgradedomainprogress) | [CurrentUpgradeDomainProgressInfo](sfclient-v72-model-currentupgradedomainprogressinfo.md) | No |
...
| [`UpgradeDomainProgressAtFailure`](#upgradedomainprogressatfailure) | [FailedUpgradeDomainProgressObject](sfclient-v72-model-failedupgradedomainprogressobject.md) | No |
...
____
### `UpgradeDomains`
__Type__: array of [UpgradeDomainInfo](sfclient-v72-model-upgradedomaininfo.md) <br/>
__Required__: No<br/>
<br/>
...
____
### `UpgradeDescription`
__Type__: [ClusterUpgradeDescriptionObject](sfclient-v72-model-clusterupgradedescriptionobject.md) <br/>
__Required__: No<br/>
<br/>
...
__Type__: array of [HealthEvaluationWrapper](sfclient-v72-model-healthevaluationwrapper.md) <br/>
__Required__: No<br/>
<br/>
...
__Type__: [CurrentUpgradeDomainProgressInfo](sfclient-v72-model-currentupgradedomainprogressinfo.md) <br/>
__Required__: No<br/>
<br/>
...
__Type__: [FailedUpgradeDomainProgressObject](sfclient-v72-model-failedupgradedomainprogressobject.md) <br/>
__Required__: No<br/>
<br/>
