...
| [PartitionDescription](#partitiondescription) | [PartitionSchemeDescription](model-PartitionSchemeDescription.md) | Yes |
...
| [ServiceLoadMetrics](#serviceloadmetrics) | array of [ServiceLoadMetricDescription](model-ServiceLoadMetricDescription.md) | No |
...
__Type__: [PartitionSchemeDescription](model-PartitionSchemeDescription.md) <br/>
__Required__: Yes<br/>
<br/>
