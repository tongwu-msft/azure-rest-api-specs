---
title: "Get Repair Task List v81"
description: "Get Repair Task List v81"
ms.date: "10/21/2020"
...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code.<br/>The response body provides a list of repair tasks matching all of the given filters.<br/> | array of [RepairTask](sfclient-v81-model-repairtask.md) |
