---
title: "Get Partitions Event List v81"
description: "Get Partitions Event List v81"
ms.date: "10/21/2020"
...
| --- | --- | --- |
| 200 (OK) | List of events objects with base type PartitionEvent.<br/> | array of [PartitionEvent](sfclient-v81-model-partitionevent.md) |
