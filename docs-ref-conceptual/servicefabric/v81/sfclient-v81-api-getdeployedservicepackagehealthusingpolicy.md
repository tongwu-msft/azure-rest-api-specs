---
title: "Get Deployed Service Package Health Using Policy v81"
description: "Get Deployed Service Package Health Using Policy v81"
ms.date: "10/21/2020"
...
translation.priority.mt: 
  ...
  - "zh-tw"
---
# Get Deployed Service Package Health Using Policy v81
...
| [`ApplicationHealthPolicy`](#applicationhealthpolicy) | [ApplicationHealthPolicy](sfclient-v81-model-applicationhealthpolicy.md) | No | Body |
...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the health information of the deployed service package for a specific node and application.<br/> | [DeployedServicePackageHealth](sfclient-v81-model-deployedservicepackagehealth.md) |
