---
title: "StatelessServiceDescription v81"
description: "StatelessServiceDescription v81"
ms.date: "04/02/2021"
...
translation.priority.mt: 
  ...
  - "zh-tw"
---
# StatelessServiceDescription v81
...
| [`PartitionDescription`](#partitiondescription) | [PartitionSchemeDescription](sfclient-v81-model-partitionschemedescription.md) | Yes |
| [`PlacementConstraints`](#placementconstraints) | string | No |
| [`CorrelationScheme`](#correlationscheme) | array of [ServiceCorrelationDescription](sfclient-v81-model-servicecorrelationdescription.md) | No |
| [`ServiceLoadMetrics`](#serviceloadmetrics) | array of [ServiceLoadMetricDescription](sfclient-v81-model-serviceloadmetricdescription.md) | No |
| [`ServicePlacementPolicies`](#serviceplacementpolicies) | array of [ServicePlacementPolicyDescription](sfclient-v81-model-serviceplacementpolicydescription.md) | No |
...
| [`ScalingPolicies`](#scalingpolicies) | array of [ScalingPolicyDescription](sfclient-v81-model-scalingpolicydescription.md) | No |
| [`TagsRequiredToPlace`](#tagsrequiredtoplace) | [NodeTagsDescription](sfclient-v81-model-nodetagsdescription.md) | No |
| [`TagsRequiredToRun`](#tagsrequiredtorun) | [NodeTagsDescription](sfclient-v81-model-nodetagsdescription.md) | No |
...
| [`InstanceLifecycleDescription`](#instancelifecycledescription) | [InstanceLifecycleDescription](sfclient-v81-model-instancelifecycledescription.md) | No |
...
__Type__: [PartitionSchemeDescription](sfclient-v81-model-partitionschemedescription.md) <br/>
__Required__: Yes<br/>
<br/>
...
____
### `CorrelationScheme`
__Type__: array of [ServiceCorrelationDescription](sfclient-v81-model-servicecorrelationdescription.md) <br/>
__Required__: No<br/>
<br/>
...
____
### `ServiceLoadMetrics`
__Type__: array of [ServiceLoadMetricDescription](sfclient-v81-model-serviceloadmetricdescription.md) <br/>
__Required__: No<br/>
<br/>
...
__Type__: array of [ServicePlacementPolicyDescription](sfclient-v81-model-serviceplacementpolicydescription.md) <br/>
__Required__: No<br/>
<br/>
...
____
### `ScalingPolicies`
__Type__: array of [ScalingPolicyDescription](sfclient-v81-model-scalingpolicydescription.md) <br/>
__Required__: No<br/>
<br/>
...
____
### `TagsRequiredToPlace`
__Type__: [NodeTagsDescription](sfclient-v81-model-nodetagsdescription.md) <br/>
__Required__: No<br/>
<br/>
...
__Type__: [InstanceLifecycleDescription](sfclient-v81-model-instancelifecycledescription.md) <br/>
__Required__: No<br/>
<br/>
