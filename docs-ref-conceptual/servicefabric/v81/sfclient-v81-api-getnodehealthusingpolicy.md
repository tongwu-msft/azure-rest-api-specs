---
title: "Get Node Health Using Policy v81"
description: "Get Node Health Using Policy v81"
ms.date: "10/21/2020"
...
translation.priority.mt: 
  ...
  - "zh-tw"
---
# Get Node Health Using Policy v81
...
| [`ClusterHealthPolicy`](#clusterhealthpolicy) | [ClusterHealthPolicy](sfclient-v81-model-clusterhealthpolicy.md) | No | Body |
...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the requested node health information.<br/> | [NodeHealth](sfclient-v81-model-nodehealth.md) |
