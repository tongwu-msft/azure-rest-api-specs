---
title: "Get Cluster Health Using Policy v81"
description: "Get Cluster Health Using Policy v81"
ms.date: "10/21/2020"
...
translation.priority.mt: 
  ...
  - "zh-tw"
---
# Get Cluster Health Using Policy v81
...
| [`ClusterHealthPolicies`](#clusterhealthpolicies) | [ClusterHealthPolicies](sfclient-v81-model-clusterhealthpolicies.md) | No | Body |
...
__Type__: [ClusterHealthPolicies](sfclient-v81-model-clusterhealthpolicies.md) <br/>
__Required__: No<br/>
<br/>
...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the requested cluster health information.<br/> | [ClusterHealth](sfclient-v81-model-clusterhealth.md) |
