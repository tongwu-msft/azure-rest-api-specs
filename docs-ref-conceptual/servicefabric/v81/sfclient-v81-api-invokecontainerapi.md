---
title: "Invoke Container Api v81"
description: "Invoke Container Api v81"
ms.date: "10/21/2020"
...
| [`ContainerApiRequestBody`](#containerapirequestbody) | [ContainerApiRequestBody](sfclient-v81-model-containerapirequestbody.md) | Yes | Body |
...
__Type__: [ContainerApiRequestBody](sfclient-v81-model-containerapirequestbody.md) <br/>
__Required__: Yes<br/>
<br/>
...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and container API response for a container deployed on a Service Fabric node for the given code package.<br/> | [ContainerApiResponse](sfclient-v81-model-containerapiresponse.md) |
