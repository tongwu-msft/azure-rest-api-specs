---
title: "NodeDeactivationInfo v81"
description: "NodeDeactivationInfo v81"
ms.date: "10/21/2020"
...
| [`NodeDeactivationTask`](#nodedeactivationtask) | array of [NodeDeactivationTask](sfclient-v81-model-nodedeactivationtask.md) | No |
| [`PendingSafetyChecks`](#pendingsafetychecks) | array of [SafetyCheckWrapper](sfclient-v81-model-safetycheckwrapper.md) | No |
...
__Type__: array of [NodeDeactivationTask](sfclient-v81-model-nodedeactivationtask.md) <br/>
__Required__: No<br/>
<br/>
...
____
### `PendingSafetyChecks`
__Type__: array of [SafetyCheckWrapper](sfclient-v81-model-safetycheckwrapper.md) <br/>
__Required__: No<br/>
<br/>
