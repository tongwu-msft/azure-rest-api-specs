---
title: "ApplicationHealthStateFilter v81"
description: "ApplicationHealthStateFilter v81"
ms.date: "10/21/2020"
...
translation.priority.mt: 
  ...
  - "zh-tw"
---
# ApplicationHealthStateFilter v81
...
| [`ServiceFilters`](#servicefilters) | array of [ServiceHealthStateFilter](sfclient-v81-model-servicehealthstatefilter.md) | No |
| [`DeployedApplicationFilters`](#deployedapplicationfilters) | array of [DeployedApplicationHealthStateFilter](sfclient-v81-model-deployedapplicationhealthstatefilter.md) | No |
...
____
### `ServiceFilters`
__Type__: array of [ServiceHealthStateFilter](sfclient-v81-model-servicehealthstatefilter.md) <br/>
__Required__: No<br/>
<br/>
...
__Type__: array of [DeployedApplicationHealthStateFilter](sfclient-v81-model-deployedapplicationhealthstatefilter.md) <br/>
__Required__: No<br/>
<br/>
