---
title: "Status and Error Codes v81"
ms.date: "11/23/2019 v81"
...
API operations may also return additional error information that is defined by Service Fabric. This additional error information is returned in the response body. The body of the error response is of [FabricError](sfclient-v81-model-FabricError.md) schema as shown below:
