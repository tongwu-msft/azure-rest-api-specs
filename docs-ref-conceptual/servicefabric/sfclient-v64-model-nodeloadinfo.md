...
| [`NodeLoadMetricInformation`](#nodeloadmetricinformation) | array of [NodeLoadMetricInformation](sfclient-v64-model-nodeloadmetricinformation.md) | No |
...
__Type__: array of [NodeLoadMetricInformation](sfclient-v64-model-nodeloadmetricinformation.md) <br/>
__Required__: No<br/>
<br/>
