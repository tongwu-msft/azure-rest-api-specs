...
| [`Items`](#items) | array of [BackupConfigurationInfo](sfclient-v70-model-backupconfigurationinfo.md) | No |
...
____
### `Items`
__Type__: array of [BackupConfigurationInfo](sfclient-v70-model-backupconfigurationinfo.md) <br/>
__Required__: No<br/>
<br/>
