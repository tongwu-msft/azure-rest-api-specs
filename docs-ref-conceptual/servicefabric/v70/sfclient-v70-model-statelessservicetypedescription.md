...
| [`Extensions`](#extensions) | array of [ServiceTypeExtensionDescription](sfclient-v70-model-servicetypeextensiondescription.md) | No |
...
____
### `Extensions`
__Type__: array of [ServiceTypeExtensionDescription](sfclient-v70-model-servicetypeextensiondescription.md) <br/>
__Required__: No<br/>
<br/>
