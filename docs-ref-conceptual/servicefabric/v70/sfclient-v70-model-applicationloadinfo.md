...
| [`ApplicationLoadMetricInformation`](#applicationloadmetricinformation) | array of [ApplicationMetricDescription](sfclient-v70-model-applicationmetricdescription.md) | No |
...
__Type__: array of [ApplicationMetricDescription](sfclient-v70-model-applicationmetricdescription.md) <br/>
__Required__: No<br/>
<br/>
