...
| [`UpgradeOrchestrationServiceState`](#upgradeorchestrationservicestate) | [UpgradeOrchestrationServiceState](sfclient-v70-model-upgradeorchestrationservicestate.md) | Yes | Body |
...
__Type__: [UpgradeOrchestrationServiceState](sfclient-v70-model-upgradeorchestrationservicestate.md) <br/>
__Required__: Yes<br/>
<br/>
...
| --- | --- | --- |
| 200 (OK) | A successful response means that the service state of Service Fabric Upgrade Orchestration Service has been updated.<br/> | [UpgradeOrchestrationServiceStateSummary](sfclient-v70-model-upgradeorchestrationservicestatesummary.md) |
