...
| [`GetBackupByStorageQueryDescription`](#getbackupbystoragequerydescription) | [GetBackupByStorageQueryDescription](sfclient-v70-model-getbackupbystoragequerydescription.md) | Yes | Body |
...
__Type__: [GetBackupByStorageQueryDescription](sfclient-v70-model-getbackupbystoragequerydescription.md) <br/>
__Required__: Yes<br/>
<br/>
...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and a paged list of backup information.<br/> | [PagedBackupInfoList](sfclient-v70-model-pagedbackupinfolist.md) |
