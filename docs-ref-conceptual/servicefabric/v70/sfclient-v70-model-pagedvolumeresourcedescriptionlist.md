...
| [`Items`](#items) | array of [VolumeResourceDescription](sfclient-v70-model-volumeresourcedescription.md) | No |
...
____
### `Items`
__Type__: array of [VolumeResourceDescription](sfclient-v70-model-volumeresourcedescription.md) <br/>
__Required__: No<br/>
<br/>
