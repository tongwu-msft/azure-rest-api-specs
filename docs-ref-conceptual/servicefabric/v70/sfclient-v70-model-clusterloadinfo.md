...
| [`LoadMetricInformation`](#loadmetricinformation) | array of [LoadMetricInformation](sfclient-v70-model-loadmetricinformation.md) | No |
...
__Type__: array of [LoadMetricInformation](sfclient-v70-model-loadmetricinformation.md) <br/>
__Required__: No<br/>
<br/>
