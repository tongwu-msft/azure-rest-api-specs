...
| [`NodeLoadMetricInformation`](#nodeloadmetricinformation) | array of [NodeLoadMetricInformation](sfclient-v70-model-nodeloadmetricinformation.md) | No |
...
__Type__: array of [NodeLoadMetricInformation](sfclient-v70-model-nodeloadmetricinformation.md) <br/>
__Required__: No<br/>
<br/>
