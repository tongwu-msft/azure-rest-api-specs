...
| [`ChaosParametersDictionary`](#chaosparametersdictionary) | array of [ChaosParametersDictionaryItem](sfclient-v70-model-chaosparametersdictionaryitem.md) | No |
| [`Jobs`](#jobs) | array of [ChaosScheduleJob](sfclient-v70-model-chaosschedulejob.md) | No |
...
__Type__: array of [ChaosParametersDictionaryItem](sfclient-v70-model-chaosparametersdictionaryitem.md) <br/>
__Required__: No<br/>
<br/>
...
____
### `Jobs`
__Type__: array of [ChaosScheduleJob](sfclient-v70-model-chaosschedulejob.md) <br/>
__Required__: No<br/>
<br/>
