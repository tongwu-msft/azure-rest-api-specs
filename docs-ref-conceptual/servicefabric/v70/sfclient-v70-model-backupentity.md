...
| --- | --- | 
| Application | [ApplicationBackupEntity](sfclient-v70-model-applicationbackupentity.md) |
| Service | [ServiceBackupEntity](sfclient-v70-model-servicebackupentity.md) |
| Partition | [PartitionBackupEntity](sfclient-v70-model-partitionbackupentity.md) |
