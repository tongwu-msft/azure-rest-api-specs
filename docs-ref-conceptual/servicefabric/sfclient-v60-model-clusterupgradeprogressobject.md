...
| [UpgradeDescription](#upgradedescription) | [ClusterUpgradeDescriptionObject](sfclient-v60-model-clusterupgradedescriptionobject.md) | No |
...
| [UpgradeDomainProgressAtFailure](#upgradedomainprogressatfailure) | [FailedUpgradeDomainProgressObject](sfclient-v60-model-failedupgradedomainprogressobject.md) | No |
...
____
### UpgradeDescription
__Type__: [ClusterUpgradeDescriptionObject](sfclient-v60-model-clusterupgradedescriptionobject.md) <br/>
__Required__: No<br/>
<br/>
...
__Type__: [FailedUpgradeDomainProgressObject](sfclient-v60-model-failedupgradedomainprogressobject.md) <br/>
__Required__: No<br/>
<br/>
