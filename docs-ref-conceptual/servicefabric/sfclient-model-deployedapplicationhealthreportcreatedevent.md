---
title: "DeployedApplicationHealthReportCreatedEvent"
ms.date: "2018-07-20"
ms.prod: "azure"
...
| [`ApplicationInstanceId`](#applicationinstanceid) | integer (int64) | Yes |
...
__Required__: Yes <br/>
<br/>
A discriminator property. Its value must be 'DeployedApplicationHealthReportCreated' for objects of type 'DeployedApplicationHealthReportCreatedEvent'.
