...
| [RemoteReplicatorAcknowledgementStatus](#remotereplicatoracknowledgementstatus) | [RemoteReplicatorAcknowledgementStatus](sfclient-v60-model-remotereplicatoracknowledgementstatus.md) | No |
...
__Type__: [RemoteReplicatorAcknowledgementStatus](sfclient-v60-model-remotereplicatoracknowledgementstatus.md) <br/>
__Required__: No<br/>
<br/>
