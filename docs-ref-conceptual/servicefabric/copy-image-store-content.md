...
| [ImageStoreCopyDescription](#imagestorecopydescription) | [ImageStoreCopyDescription](model-ImageStoreCopyDescription.md) | Yes | Body |
...
__Type__: [ImageStoreCopyDescription](model-ImageStoreCopyDescription.md) <br/>
__Required__: Yes<br/>
<br/>
