...
| --- | --- | 
| Stateful | [StatefulServicePartitionInfo](sfclient-model-statefulservicepartitioninfo.md) |
| Stateless | [StatelessServicePartitionInfo](sfclient-model-statelessservicepartitioninfo.md) |
