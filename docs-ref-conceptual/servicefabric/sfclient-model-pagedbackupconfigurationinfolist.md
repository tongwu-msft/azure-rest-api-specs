...
description: "PagedBackupConfigurationInfoList"
ms.date: "04/02/2021"
...
| [`Items`](#items) | array of [BackupConfigurationInfo](sfclient-model-backupconfigurationinfo.md) | No |
...
____
### `Items`
__Type__: array of [BackupConfigurationInfo](sfclient-model-backupconfigurationinfo.md) <br/>
__Required__: No<br/>
<br/>
