...
| Method | Request URI |
| ------ | ----------- |
| GET | `/Services/{serviceId}/$/GetPartitions?api-version=6.0&ContinuationToken={ContinuationToken}&timeout={timeout}` |
...
| --- | --- | --- |
| 200 (OK) | List of partitions of a Service Fabric service.<br/> | [PagedServicePartitionInfoList](sfclient-v61-model-pagedservicepartitioninfolist.md) |
