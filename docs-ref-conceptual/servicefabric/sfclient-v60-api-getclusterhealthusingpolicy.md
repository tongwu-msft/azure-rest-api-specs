...
| [ClusterHealthPolicies](#clusterhealthpolicies) | [ClusterHealthPolicies](sfclient-v60-model-clusterhealthpolicies.md) | No | Body |
...
__Type__: [ClusterHealthPolicies](sfclient-v60-model-clusterhealthpolicies.md) <br/>
__Required__: No<br/>
<br/>
...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the requested cluster health information.<br/> | [ClusterHealth](sfclient-v60-model-clusterhealth.md) |
