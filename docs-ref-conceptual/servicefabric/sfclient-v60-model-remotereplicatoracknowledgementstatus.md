...
| [CopyStreamAcknowledgementDetail](#copystreamacknowledgementdetail) | [RemoteReplicatorAcknowledgementDetail](sfclient-v60-model-remotereplicatoracknowledgementdetail.md) | No |

____
### ReplicationStreamAcknowledgementDetail
__Type__: [RemoteReplicatorAcknowledgementDetail](sfclient-v60-model-remotereplicatoracknowledgementdetail.md) <br/>
__Required__: No<br/>
<br/>
