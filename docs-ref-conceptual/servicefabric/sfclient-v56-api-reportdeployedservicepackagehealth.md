...
| Method | Request URI |
| ------ | ----------- |
| POST | `/Nodes/{nodeName}/$/GetApplications/{applicationId}/$/GetServicePackages/{servicePackageName}/$/ReportHealth?api-version=3.0&timeout={timeout}` |
...
| [HealthInformation](#healthinformation) | [HealthInformation](sfclient-v56-model-healthinformation.md) | Yes | Body |
...
____
### HealthInformation
__Type__: [HealthInformation](sfclient-v56-model-healthinformation.md) <br/>
__Required__: Yes<br/>
<br/>
