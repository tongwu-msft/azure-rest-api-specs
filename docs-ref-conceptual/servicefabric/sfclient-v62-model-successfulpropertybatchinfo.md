...
| [`Properties`](#properties) | map of string to [PropertyInfo](sfclient-v62-model-propertyinfo.md) | No |
...
____
### `Properties`
__Type__: map of string to [PropertyInfo](sfclient-v62-model-propertyinfo.md) <br/>
__Required__: No<br/>
<br/>
