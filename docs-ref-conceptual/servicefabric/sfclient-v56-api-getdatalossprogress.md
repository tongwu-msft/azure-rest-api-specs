...
| --- | --- | --- |
| 200 (OK) | Information about the progress of the partition data loss operation.<br/> | [PartitionDataLossProgress](sfclient-v56-model-partitiondatalossprogress.md) |
