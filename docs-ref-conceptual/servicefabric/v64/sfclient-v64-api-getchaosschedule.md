...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the schedule description including a Chaos Schedule used by Chaos and the version the Chaos Schedule is on.<br/> | [ChaosScheduleDescription](sfclient-v64-model-chaosscheduledescription.md) |
