...
| Name | Type | Required |
| --- | --- | --- |
| [`NodeFilters`](#nodefilters) | array of [NodeHealthStateFilter](sfclient-v64-model-nodehealthstatefilter.md) | No |
| [`ApplicationFilters`](#applicationfilters) | array of [ApplicationHealthStateFilter](sfclient-v64-model-applicationhealthstatefilter.md) | No |
| [`ClusterHealthPolicy`](#clusterhealthpolicy) | [ClusterHealthPolicy](sfclient-v64-model-clusterhealthpolicy.md) | No |
| [`ApplicationHealthPolicies`](#applicationhealthpolicies) | [ApplicationHealthPolicies](sfclient-v64-model-applicationhealthpolicies.md) | No |

____
### `NodeFilters`
__Type__: array of [NodeHealthStateFilter](sfclient-v64-model-nodehealthstatefilter.md) <br/>
__Required__: No<br/>
<br/>
...
____
### `ApplicationFilters`
__Type__: array of [ApplicationHealthStateFilter](sfclient-v64-model-applicationhealthstatefilter.md) <br/>
__Required__: No<br/>
<br/>
...
____
### `ClusterHealthPolicy`
__Type__: [ClusterHealthPolicy](sfclient-v64-model-clusterhealthpolicy.md) <br/>
__Required__: No<br/>
<br/>
...
__Type__: [ApplicationHealthPolicies](sfclient-v64-model-applicationhealthpolicies.md) <br/>
__Required__: No<br/>
<br/>
