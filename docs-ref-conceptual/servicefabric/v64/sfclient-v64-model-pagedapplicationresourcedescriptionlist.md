...
| [`Items`](#items) | array of [ApplicationResourceDescription](sfclient-v64-model-applicationresourcedescription.md) | No |
...
____
### `Items`
__Type__: array of [ApplicationResourceDescription](sfclient-v64-model-applicationresourcedescription.md) <br/>
__Required__: No<br/>
<br/>
