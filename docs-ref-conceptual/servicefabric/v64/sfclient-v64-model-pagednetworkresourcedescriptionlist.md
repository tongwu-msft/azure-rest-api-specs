...
| [`Items`](#items) | array of [NetworkResourceDescription](sfclient-v64-model-networkresourcedescription.md) | No |
...
____
### `Items`
__Type__: array of [NetworkResourceDescription](sfclient-v64-model-networkresourcedescription.md) <br/>
__Required__: No<br/>
<br/>
