...
| [`Target`](#target) | [RepairTargetDescriptionBase](sfclient-v64-model-repairtargetdescriptionbase.md) | No |
| [`Executor`](#executor) | string | No |
| [`ExecutorData`](#executordata) | string | No |
| [`Impact`](#impact) | [RepairImpactDescriptionBase](sfclient-v64-model-repairimpactdescriptionbase.md) | No |
| [`ResultStatus`](#resultstatus) | string (enum) | No |
| [`ResultCode`](#resultcode) | integer | No |
| [`ResultDetails`](#resultdetails) | string | No |
| [`History`](#history) | [RepairTaskHistory](sfclient-v64-model-repairtaskhistory.md) | No |
...
____
### `Target`
__Type__: [RepairTargetDescriptionBase](sfclient-v64-model-repairtargetdescriptionbase.md) <br/>
__Required__: No<br/>
<br/>
...
____
### `Impact`
__Type__: [RepairImpactDescriptionBase](sfclient-v64-model-repairimpactdescriptionbase.md) <br/>
__Required__: No<br/>
<br/>
...
____
### `History`
__Type__: [RepairTaskHistory](sfclient-v64-model-repairtaskhistory.md) <br/>
__Required__: No<br/>
<br/>
