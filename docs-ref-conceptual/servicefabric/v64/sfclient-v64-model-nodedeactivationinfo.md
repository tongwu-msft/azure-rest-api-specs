...
| [`NodeDeactivationTask`](#nodedeactivationtask) | array of [NodeDeactivationTask](sfclient-v64-model-nodedeactivationtask.md) | No |
...
__Type__: array of [NodeDeactivationTask](sfclient-v64-model-nodedeactivationtask.md) <br/>
__Required__: No<br/>
<br/>
