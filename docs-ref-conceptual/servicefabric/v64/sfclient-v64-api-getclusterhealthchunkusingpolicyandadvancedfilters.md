...
| [`ClusterHealthChunkQueryDescription`](#clusterhealthchunkquerydescription) | [ClusterHealthChunkQueryDescription](sfclient-v64-model-clusterhealthchunkquerydescription.md) | No | Body |
...
__Type__: [ClusterHealthChunkQueryDescription](sfclient-v64-model-clusterhealthchunkquerydescription.md) <br/>
__Required__: No<br/>
<br/>
...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the requested cluster health chunk information.<br/> | [ClusterHealthChunk](sfclient-v64-model-clusterhealthchunk.md) |
