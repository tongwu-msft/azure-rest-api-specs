...
| [`Items`](#items) | array of [ServiceResourceDescription](sfclient-v64-model-serviceresourcedescription.md) | No |
...
____
### `Items`
__Type__: array of [ServiceResourceDescription](sfclient-v64-model-serviceresourcedescription.md) <br/>
__Required__: No<br/>
<br/>
