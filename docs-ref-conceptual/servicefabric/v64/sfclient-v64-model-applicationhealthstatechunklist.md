...
| [`Items`](#items) | array of [ApplicationHealthStateChunk](sfclient-v64-model-applicationhealthstatechunk.md) | No |
...
____
### `Items`
__Type__: array of [ApplicationHealthStateChunk](sfclient-v64-model-applicationhealthstatechunk.md) <br/>
__Required__: No<br/>
<br/>
