...
| [`PartitionDescription`](#partitiondescription) | [PartitionSchemeDescription](sfclient-v64-model-partitionschemedescription.md) | Yes |
| [`PlacementConstraints`](#placementconstraints) | string | No |
| [`CorrelationScheme`](#correlationscheme) | array of [ServiceCorrelationDescription](sfclient-v64-model-servicecorrelationdescription.md) | No |
| [`ServiceLoadMetrics`](#serviceloadmetrics) | array of [ServiceLoadMetricDescription](sfclient-v64-model-serviceloadmetricdescription.md) | No |
| [`ServicePlacementPolicies`](#serviceplacementpolicies) | array of [ServicePlacementPolicyDescription](sfclient-v64-model-serviceplacementpolicydescription.md) | No |
...
| [`ScalingPolicies`](#scalingpolicies) | array of [ScalingPolicyDescription](sfclient-v64-model-scalingpolicydescription.md) | No |
...
__Type__: [PartitionSchemeDescription](sfclient-v64-model-partitionschemedescription.md) <br/>
__Required__: Yes<br/>
<br/>
...
____
### `CorrelationScheme`
__Type__: array of [ServiceCorrelationDescription](sfclient-v64-model-servicecorrelationdescription.md) <br/>
__Required__: No<br/>
<br/>
...
____
### `ServiceLoadMetrics`
__Type__: array of [ServiceLoadMetricDescription](sfclient-v64-model-serviceloadmetricdescription.md) <br/>
__Required__: No<br/>
<br/>
...
__Type__: array of [ServicePlacementPolicyDescription](sfclient-v64-model-serviceplacementpolicydescription.md) <br/>
__Required__: No<br/>
<br/>
...
____
### `ScalingPolicies`
__Type__: array of [ScalingPolicyDescription](sfclient-v64-model-scalingpolicydescription.md) <br/>
__Required__: No<br/>
<br/>
