...
| [`ExpectedRanges`](#expectedranges) | array of [UploadChunkRange](sfclient-v64-model-uploadchunkrange.md) | No |
...
____
### `ExpectedRanges`
__Type__: array of [UploadChunkRange](sfclient-v64-model-uploadchunkrange.md) <br/>
__Required__: No<br/>
<br/>
