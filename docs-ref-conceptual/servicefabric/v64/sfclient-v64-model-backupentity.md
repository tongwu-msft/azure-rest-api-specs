...
| --- | --- | 
| Application | [ApplicationBackupEntity](sfclient-v64-model-applicationbackupentity.md) |
| Service | [ServiceBackupEntity](sfclient-v64-model-servicebackupentity.md) |
| Partition | [PartitionBackupEntity](sfclient-v64-model-partitionbackupentity.md) |
