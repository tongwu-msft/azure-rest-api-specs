...
| --- | --- | --- |
| 202 (Accepted) | A 202 status code indicates the operation request was accepted and application backup will be suspended.<br/> |  |
...
This example shows how to suspend backup for a stateful application which is configured for periodic backup.

#### Request
```
POST http://localhost:19080/Applications/CalcApp/$/SuspendBackup?api-version=6.2-preview
```
