...
| [`ClusterHealthChunkQueryDescription`](#clusterhealthchunkquerydescription) | [ClusterHealthChunkQueryDescription](sfclient-v63-model-clusterhealthchunkquerydescription.md) | No | Body |
...
__Type__: [ClusterHealthChunkQueryDescription](sfclient-v63-model-clusterhealthchunkquerydescription.md) <br/>
__Required__: No<br/>
<br/>
...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the requested cluster health chunk information.<br/> | [ClusterHealthChunk](sfclient-v63-model-clusterhealthchunk.md) |
