...
| [NodeHealthStates](#nodehealthstates) | array of [NodeHealthState](model-NodeHealthState.md) | No |
| [ApplicationHealthStates](#applicationhealthstates) | array of [ApplicationHealthState](model-ApplicationHealthState.md) | No |
...
____
### NodeHealthStates
__Type__: array of [NodeHealthState](model-NodeHealthState.md) <br/>
__Required__: No<br/>
<br/>
...
__Type__: array of [ApplicationHealthState](model-ApplicationHealthState.md) <br/>
__Required__: No<br/>
<br/>
