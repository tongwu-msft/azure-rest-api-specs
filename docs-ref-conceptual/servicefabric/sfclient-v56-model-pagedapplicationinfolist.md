...
| [Items](#items) | array of [ApplicationInfo](sfclient-v56-model-applicationinfo.md) | No |
...
____
### Items
__Type__: array of [ApplicationInfo](sfclient-v56-model-applicationinfo.md) <br/>
__Required__: No<br/>
<br/>
