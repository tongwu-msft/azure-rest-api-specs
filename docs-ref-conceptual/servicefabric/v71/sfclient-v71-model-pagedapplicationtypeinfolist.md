...
| [`Items`](#items) | array of [ApplicationTypeInfo](sfclient-v71-model-applicationtypeinfo.md) | No |
...
____
### `Items`
__Type__: array of [ApplicationTypeInfo](sfclient-v71-model-applicationtypeinfo.md) <br/>
__Required__: No<br/>
<br/>
