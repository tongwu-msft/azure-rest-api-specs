...
| [`ApplicationTypeHealthPolicyMap`](#applicationtypehealthpolicymap) | array of [ApplicationTypeHealthPolicyMapItem](sfclient-v71-model-applicationtypehealthpolicymapitem.md) | No |
...
__Type__: array of [ApplicationTypeHealthPolicyMapItem](sfclient-v71-model-applicationtypehealthpolicymapitem.md) <br/>
__Required__: No<br/>
<br/>
