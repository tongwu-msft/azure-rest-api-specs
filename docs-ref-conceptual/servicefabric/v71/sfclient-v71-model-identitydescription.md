...
| [`userAssignedIdentities`](#userassignedidentities) | map of string to [IdentityItemDescription](sfclient-v71-model-identityitemdescription.md) | No |
...
__Type__: map of string to [IdentityItemDescription](sfclient-v71-model-identityitemdescription.md) <br/>
__Required__: No<br/>
<br/>
