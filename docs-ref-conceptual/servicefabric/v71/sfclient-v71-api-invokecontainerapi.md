...
| [`ContainerApiRequestBody`](#containerapirequestbody) | [ContainerApiRequestBody](sfclient-v71-model-containerapirequestbody.md) | Yes | Body |
...
__Type__: [ContainerApiRequestBody](sfclient-v71-model-containerapirequestbody.md) <br/>
__Required__: Yes<br/>
<br/>
...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and container API response for a container deployed on a Service Fabric node for the given code package.<br/> | [ContainerApiResponse](sfclient-v71-model-containerapiresponse.md) |
