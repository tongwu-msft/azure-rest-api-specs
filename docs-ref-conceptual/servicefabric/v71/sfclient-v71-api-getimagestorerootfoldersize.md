...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the requested folder size in image store.<br/> | [FolderSizeInfo](sfclient-v71-model-foldersizeinfo.md) |
