...
| [`ServiceUpgradeProgress`](#serviceupgradeprogress) | array of [ServiceUpgradeProgress](sfclient-v71-model-serviceupgradeprogress.md) | No |
...
__Type__: array of [ServiceUpgradeProgress](sfclient-v71-model-serviceupgradeprogress.md) <br/>
__Required__: No<br/>
<br/>
