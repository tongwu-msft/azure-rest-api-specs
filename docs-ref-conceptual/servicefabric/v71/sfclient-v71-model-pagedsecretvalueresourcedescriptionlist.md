...
| [`Items`](#items) | array of [SecretValueResourceDescription](sfclient-v71-model-secretvalueresourcedescription.md) | No |
...
____
### `Items`
__Type__: array of [SecretValueResourceDescription](sfclient-v71-model-secretvalueresourcedescription.md) <br/>
__Required__: No<br/>
<br/>
