...
| [`codePackages`](#codepackages) | array of [ContainerCodePackageProperties](sfclient-v71-model-containercodepackageproperties.md) | Yes |
| [`networkRefs`](#networkrefs) | array of [NetworkRef](sfclient-v71-model-networkref.md) | No |
| [`diagnostics`](#diagnostics) | [DiagnosticsRef](sfclient-v71-model-diagnosticsref.md) | No |
| [`description`](#description) | string | No |
| [`replicaCount`](#replicacount) | integer | No |
| [`executionPolicy`](#executionpolicy) | [ExecutionPolicy](sfclient-v71-model-executionpolicy.md) | No |
| [`autoScalingPolicies`](#autoscalingpolicies) | array of [AutoScalingPolicy](sfclient-v71-model-autoscalingpolicy.md) | No |
| [`status`](#status) | string (enum) | No |
| [`statusDetails`](#statusdetails) | string | No |
| [`healthState`](#healthstate) | string (enum) | No |
| [`unhealthyEvaluation`](#unhealthyevaluation) | string | No |
| [`identityRefs`](#identityrefs) | array of [ServiceIdentity](sfclient-v71-model-serviceidentity.md) | No |
...
____
### `codePackages`
__Type__: array of [ContainerCodePackageProperties](sfclient-v71-model-containercodepackageproperties.md) <br/>
__Required__: Yes<br/>
<br/>
...
____
### `networkRefs`
__Type__: array of [NetworkRef](sfclient-v71-model-networkref.md) <br/>
__Required__: No<br/>
<br/>
...
____
### `executionPolicy`
__Type__: [ExecutionPolicy](sfclient-v71-model-executionpolicy.md) <br/>
__Required__: No<br/>
<br/>
...
____
### `autoScalingPolicies`
__Type__: array of [AutoScalingPolicy](sfclient-v71-model-autoscalingpolicy.md) <br/>
__Required__: No<br/>
<br/>
...
____
### `identityRefs`
__Type__: array of [ServiceIdentity](sfclient-v71-model-serviceidentity.md) <br/>
__Required__: No<br/>
<br/>
