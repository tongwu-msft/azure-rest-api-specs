...
| [`Items`](#items) | array of [BackupPolicyDescription](sfclient-v71-model-backuppolicydescription.md) | No |
...
____
### `Items`
__Type__: array of [BackupPolicyDescription](sfclient-v71-model-backuppolicydescription.md) <br/>
__Required__: No<br/>
<br/>
