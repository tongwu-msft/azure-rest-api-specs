...
| [`ApplicationLoadMetricInformation`](#applicationloadmetricinformation) | array of [ApplicationLoadMetricInformation](sfclient-v71-model-applicationloadmetricinformation.md) | No |
...
__Type__: array of [ApplicationLoadMetricInformation](sfclient-v71-model-applicationloadmetricinformation.md) <br/>
__Required__: No<br/>
<br/>
