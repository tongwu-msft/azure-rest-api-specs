...
| --- | --- | --- |
| 200 (OK) | List of status of compose deployments in the cluster.<br/> | [PagedComposeDeploymentStatusInfoList](sfclient-v71-model-pagedcomposedeploymentstatusinfolist.md) |
