...
| [`Items`](#items) | array of [ServiceReplicaDescription](sfclient-v71-model-servicereplicadescription.md) | No |
...
____
### `Items`
__Type__: array of [ServiceReplicaDescription](sfclient-v71-model-servicereplicadescription.md) <br/>
__Required__: No<br/>
<br/>
