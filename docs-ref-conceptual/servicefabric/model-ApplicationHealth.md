...
| [Name](#name) | string | No |
| [ServiceHealthStates](#servicehealthstates) | array of [ServiceHealthState](model-ServiceHealthState.md) | No |
| [DeployedApplicationHealthStates](#deployedapplicationhealthstates) | array of [DeployedApplicationHealthState](model-DeployedApplicationHealthState.md) | No |
...
____
### ServiceHealthStates
__Type__: array of [ServiceHealthState](model-ServiceHealthState.md) <br/>
__Required__: No<br/>
<br/>
...
__Type__: array of [DeployedApplicationHealthState](model-DeployedApplicationHealthState.md) <br/>
__Required__: No<br/>
<br/>
