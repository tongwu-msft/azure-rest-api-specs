...
| [NodeLoadMetricInformation](#nodeloadmetricinformation) | array of [NodeLoadMetricInformation](sfclient-v60-model-nodeloadmetricinformation.md) | No |
...
__Type__: array of [NodeLoadMetricInformation](sfclient-v60-model-nodeloadmetricinformation.md) <br/>
__Required__: No<br/>
<br/>
