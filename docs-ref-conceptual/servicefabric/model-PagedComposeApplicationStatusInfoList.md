...
| [Items](#items) | array of [ComposeApplicationStatusInfo](model-ComposeApplicationStatusInfo.md) | No |
...
____
### Items
__Type__: array of [ComposeApplicationStatusInfo](model-ComposeApplicationStatusInfo.md) <br/>
__Required__: No<br/>
<br/>
