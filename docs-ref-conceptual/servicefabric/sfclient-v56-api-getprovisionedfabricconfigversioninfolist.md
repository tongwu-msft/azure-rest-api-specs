...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the requested provisioned config versions information.<br/> | array of [FabricConfigVersionInfo](sfclient-v56-model-fabricconfigversioninfo.md) |
