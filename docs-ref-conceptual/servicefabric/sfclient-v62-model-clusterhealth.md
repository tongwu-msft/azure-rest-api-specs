...
| [`NodeHealthStates`](#nodehealthstates) | array of [NodeHealthState](sfclient-v62-model-nodehealthstate.md) | No |
| [`ApplicationHealthStates`](#applicationhealthstates) | array of [ApplicationHealthState](sfclient-v62-model-applicationhealthstate.md) | No |
...
____
### `NodeHealthStates`
__Type__: array of [NodeHealthState](sfclient-v62-model-nodehealthstate.md) <br/>
__Required__: No<br/>
<br/>
...
__Type__: array of [ApplicationHealthState](sfclient-v62-model-applicationhealthstate.md) <br/>
__Required__: No<br/>
<br/>
