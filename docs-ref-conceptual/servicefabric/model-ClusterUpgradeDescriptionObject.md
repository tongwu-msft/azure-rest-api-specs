...
| [ClusterUpgradeHealthPolicy](#clusterupgradehealthpolicy) | [ClusterUpgradeHealthPolicyObject](model-ClusterUpgradeHealthPolicyObject.md) | No |
...
__Type__: [ClusterUpgradeHealthPolicyObject](model-ClusterUpgradeHealthPolicyObject.md) <br/>
__Required__: No<br/>
<br/>
