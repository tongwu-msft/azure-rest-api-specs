...
| [`sourceNetwork`](#sourcenetwork) | [NetworkRef](sfclient-model-networkref.md) | Yes |
| [`destinationNetwork`](#destinationnetwork) | [NetworkRef](sfclient-model-networkref.md) | Yes |
| [`tcp`](#tcp) | array of [TcpConfig](sfclient-model-tcpconfig.md) | No |
| [`http`](#http) | array of [HttpConfig](sfclient-model-httpconfig.md) | No |
...
____
### `sourceNetwork`
__Type__: [NetworkRef](sfclient-model-networkref.md) <br/>
__Required__: Yes<br/>
<br/>
...
____
### `tcp`
__Type__: array of [TcpConfig](sfclient-model-tcpconfig.md) <br/>
__Required__: No<br/>
<br/>
...
____
### `http`
__Type__: array of [HttpConfig](sfclient-model-httpconfig.md) <br/>
__Required__: No<br/>
<br/>
