...
| [`Items`](#items) | array of [ApplicationResourceDescription](sfclient-model-applicationresourcedescription.md) | No |
...
____
### `Items`
__Type__: array of [ApplicationResourceDescription](sfclient-model-applicationresourcedescription.md) <br/>
__Required__: No<br/>
<br/>
