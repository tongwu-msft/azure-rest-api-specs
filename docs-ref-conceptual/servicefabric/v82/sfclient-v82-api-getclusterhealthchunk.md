---
title: "Get Cluster Health Chunk v82"
description: "Get Cluster Health Chunk v82"
ms.date: "10/21/2020"
...
| Method | Request URI |
| ------ | ----------- |
| GET | `/$/GetClusterHealthChunk?api-version=6.0&timeout={timeout}` |
...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the requested cluster health chunk information.<br/> | [ClusterHealthChunk](sfclient-v82-model-clusterhealthchunk.md) |
