---
title: "ApplicationHealthStateFilter v82"
description: "ApplicationHealthStateFilter v82"
ms.date: "10/21/2020"
...
translation.priority.mt: 
  ...
  - "zh-tw"
---
# ApplicationHealthStateFilter v82
...
| [`ServiceFilters`](#servicefilters) | array of [ServiceHealthStateFilter](sfclient-v82-model-servicehealthstatefilter.md) | No |
| [`DeployedApplicationFilters`](#deployedapplicationfilters) | array of [DeployedApplicationHealthStateFilter](sfclient-v82-model-deployedapplicationhealthstatefilter.md) | No |
...
____
### `ServiceFilters`
__Type__: array of [ServiceHealthStateFilter](sfclient-v82-model-servicehealthstatefilter.md) <br/>
__Required__: No<br/>
<br/>
...
__Type__: array of [DeployedApplicationHealthStateFilter](sfclient-v82-model-deployedapplicationhealthstatefilter.md) <br/>
__Required__: No<br/>
<br/>
