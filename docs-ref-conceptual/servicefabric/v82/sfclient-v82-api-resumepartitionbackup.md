---
title: "Resume Partition Backup v82"
description: "Resume Partition Backup v82"
ms.date: "10/21/2020"
...
| Method | Request URI |
| ------ | ----------- |
| POST | `/Partitions/{partitionId}/$/ResumeBackup?api-version=6.4&timeout={timeout}` |
...
#### Request
```
POST http://localhost:19080/Partitions/1daae3f5-7fd6-42e9-b1ba-8c05f873994d/$/ResumeBackup?api-version=6.4
```
