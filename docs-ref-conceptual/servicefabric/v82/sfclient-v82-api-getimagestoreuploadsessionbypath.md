---
title: "Get Image Store Upload Session By Path v82"
description: "Get Image Store Upload Session By Path v82"
ms.date: "10/21/2020"
...
translation.priority.mt: 
  ...
  - "zh-tw"
---
# Get Image Store Upload Session By Path v82
...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the requested image store upload session information.<br/> | [UploadSession](sfclient-v82-model-uploadsession.md) |
