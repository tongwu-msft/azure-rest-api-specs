---
title: "Get Partition Health v82"
description: "Get Partition Health v82"
ms.date: "10/21/2020"
...
| Method | Request URI |
| ------ | ----------- |
| GET | `/Partitions/{partitionId}/$/GetHealth?api-version=6.0&EventsHealthStateFilter={EventsHealthStateFilter}&ReplicasHealthStateFilter={ReplicasHealthStateFilter}&ExcludeHealthStatistics={ExcludeHealthStatistics}&timeout={timeout}` |
...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the health information about the specified partition.<br/> | [PartitionHealth](sfclient-v82-model-partitionhealth.md) |
