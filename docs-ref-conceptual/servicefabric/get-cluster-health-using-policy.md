...
| [ClusterHealthPolicies](#clusterhealthpolicies) | [ClusterHealthPolicies](model-ClusterHealthPolicies.md) | No | Body |
...
__Type__: [ClusterHealthPolicies](model-ClusterHealthPolicies.md) <br/>
__Required__: No<br/>
<br/>
...
| --- | --- | --- |
| 200 (OK) | A successful operation will return 200 status code and the requested cluster health information.<br/> | [ClusterHealth](model-ClusterHealth.md) |
