...
| Name | Type | Required |
| --- | --- | --- |
| [NodeDeactivationTaskId](#nodedeactivationtaskid) | [NodeDeactivationTaskId](model-NodeDeactivationTaskId.md) | No |
| [NodeDeactivationIntent](#nodedeactivationintent) | string (enum) | No |

____
### NodeDeactivationTaskId
__Type__: [NodeDeactivationTaskId](model-NodeDeactivationTaskId.md) <br/>
__Required__: No<br/>
<br/>
