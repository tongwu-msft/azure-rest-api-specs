...
| [DeployedServicePackageHealthStates](#deployedservicepackagehealthstates) | array of [DeployedServicePackageHealthState](model-DeployedServicePackageHealthState.md) | No |
...
__Type__: array of [DeployedServicePackageHealthState](model-DeployedServicePackageHealthState.md) <br/>
__Required__: No<br/>
<br/>
