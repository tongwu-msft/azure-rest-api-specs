...
| [`NodeLoadMetricInformation`](#nodeloadmetricinformation) | array of [NodeLoadMetricInformation](sfclient-v62-model-nodeloadmetricinformation.md) | No |
...
__Type__: array of [NodeLoadMetricInformation](sfclient-v62-model-nodeloadmetricinformation.md) <br/>
__Required__: No<br/>
<br/>
