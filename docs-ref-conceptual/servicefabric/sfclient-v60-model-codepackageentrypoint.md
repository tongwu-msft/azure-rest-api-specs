...
| [CodePackageEntryPointStatistics](#codepackageentrypointstatistics) | [CodePackageEntryPointStatistics](sfclient-v60-model-codepackageentrypointstatistics.md) | No |
...
__Type__: [CodePackageEntryPointStatistics](sfclient-v60-model-codepackageentrypointstatistics.md) <br/>
__Required__: No<br/>
<br/>
