...
| [UpgradeDomains](#upgradedomains) | array of [UpgradeDomainInfo](sfclient-v56-model-upgradedomaininfo.md) | No |
...
| [UpgradeDescription](#upgradedescription) | [ClusterUpgradeDescriptionObject](sfclient-v56-model-clusterupgradedescriptionobject.md) | No |
...
| [CurrentUpgradeDomainProgress](#currentupgradedomainprogress) | [CurrentUpgradeDomainProgressInfo](sfclient-v56-model-currentupgradedomainprogressinfo.md) | No |
...
| [UpgradeDomainProgressAtFailure](#upgradedomainprogressatfailure) | [FailedUpgradeDomainProgressObject](sfclient-v56-model-failedupgradedomainprogressobject.md) | No |
...
____
### UpgradeDomains
__Type__: array of [UpgradeDomainInfo](sfclient-v56-model-upgradedomaininfo.md) <br/>
__Required__: No<br/>
<br/>
...
____
### UpgradeDescription
__Type__: [ClusterUpgradeDescriptionObject](sfclient-v56-model-clusterupgradedescriptionobject.md) <br/>
__Required__: No<br/>
<br/>
...
__Type__: [CurrentUpgradeDomainProgressInfo](sfclient-v56-model-currentupgradedomainprogressinfo.md) <br/>
__Required__: No<br/>
<br/>
...
__Type__: [FailedUpgradeDomainProgressObject](sfclient-v56-model-failedupgradedomainprogressobject.md) <br/>
__Required__: No<br/>
<br/>
