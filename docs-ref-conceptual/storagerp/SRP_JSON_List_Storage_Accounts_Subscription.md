...
Formatted list of storage accounts and their properties. See the Response section of the [Get Storage Account Properties](xref:management.azure.com.storageresourceprovider.storageaccounts.getproperties) operation for the full set of properties and descriptions.
