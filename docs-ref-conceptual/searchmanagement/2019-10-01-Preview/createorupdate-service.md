...
```http
PUT https://management.azure.com/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Search/searchServices/{searchServiceName}?api-version=2019-10-01-Preview
```
...
- name: SearchService
  ...
  - name: properties.networkRuleSet
    description: Network specific rules that determine how the Azure Cognitive Search service may be reached.
    types:
    - uid: NetworkRuleSet
