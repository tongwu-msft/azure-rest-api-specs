...
|<a name="freshness" />freshness|Filter search results by age. Age refers to the date and time when Bing discovered the webpage. The following are the possible filter values.<br /><br /><ul><li>Day&mdash;Return webpages discovered within the last 24 hours<br /></li><li>Week&mdash;Return webpages discovered within the last 7 days<br /></li><li>Month&mdash;Return webpages discovered within the last 30 days</li></ul><br /><br /> **NOTE:** This filter applies only to webpage results and not to other results such as news and images.|String|No|  
