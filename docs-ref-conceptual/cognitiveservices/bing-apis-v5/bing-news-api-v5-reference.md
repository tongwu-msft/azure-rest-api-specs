...
|<a name="freshness" />freshness|Filter news articles by age. Age refers to the date and time that Bing discovered the article. The following are the possible filter values.<br /><br /><ul><li>Day&mdash;Return news articles discovered within the last 24 hours<br /></li><li>Week&mdash;Return news articles discovered within the last 7 days<br /></li><li>Month&mdash;Return news articles discovered within the last 30 days</li></ul><br /><br /> **NOTE:** Trending News ignores this parameter.|String|No|  
...
|<a name="safesearch" />safeSearch|A filter used to filter news articles for adult content. The following are the possible filter values.<br /><br /></li><li>Off&mdash;Return news articles with adult text, images, or videos.<br /><br/></li><li>Moderate&mdash;Return news articles with adult text; however, the articles does not include adult images or videos.<br /><br/></li><li>Strict&mdash;Do not return news articles with adult text, images, or videos.</li></ul><br /><br /> If not specified, the default is Moderate.<br /><br /> **NOTE:** If the request comes from a market that Bing's adult policy requires that `safeSearch` is set to Strict, Bing ignores the `safeSearch` value and uses Strict.|String|No|  
