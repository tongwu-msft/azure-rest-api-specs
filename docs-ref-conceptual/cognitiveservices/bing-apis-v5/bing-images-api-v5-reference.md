...
|<a name="color" />color|Filter images by color. The following are the possible filter values.<br /><br /><ul><li>ColorOnly&mdash;Return color images</li><li>Monochrome&mdash;Return black and white images</li></ul><br /><br/>Return images with one of the following dominant colors:<br/><br/><ul><li>Black</li><li>Blue</li><li>Brown</li><li>Gray</li><li>Green</li><li>Orange</li><li>Pink</li><li>Purple</li><li>Red</li><li>Teal</li><li>White</li><li>Yellow</li></ul>|String|  
