...
|<a name="freshness" />freshness|Filter news articles by the following age values:<br /><ul><li>Day&mdash;Return news articles that Bing discovered within the last 24 hours</li><li>Week&mdash;Return news articles that Bing discovered within the last 7 days</li><li>Month&mdash;Return news articles that Bing discovered within the last 30 days|String|No|  
