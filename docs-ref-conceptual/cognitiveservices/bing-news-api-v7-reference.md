...
|<a name="freshness" />freshness|Filter news articles by the following age values:<br /><ul><li>Day&mdash;Return news articles that Bing discovered within the last 24 hours</li><li>Week&mdash;Return news articles that Bing discovered within the last 7 days</li><li>Month&mdash;Return news articles that Bing discovered within the last 30 days</li><li>Year&mdash;Return images discovered within the last year</li></ul><br /> Trending Topics ignores this parameter.|String|No|  
