...
For information about permitted use and display of results, see [Use and display requirements](https://docs.microsoft.com/azure/cognitive-services/bing-web-search/useanddisplayrequirements).
...
|[LocalEntityAnswer](#localentityanswer)|Defines a local entity answer.|  
...
|----------|-----------|----------|  
|_type|Type hint.|String|  
|value|A list of local entities, such as local restaurants or hotels.|[Place](#place)[]|  
...
|entities|A list of entities that are relevant to the search query.|[EntityAnswer](#entityanswer)|  
|places|A list of local entities such as restaurants or hotels that are relevant to the search query.|[LocalEntityAnswer](#localentityanswer)|  
