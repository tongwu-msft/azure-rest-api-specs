...
|<a name="freshness" />freshness|Filter images by when Bing discovered the image. The following are the possible filter values.<br /><ul><li>Day&mdash;Return images discovered within the last 24 hours</li><li>Week&mdash;Return images discovered within the last 7 days</li><li>Month&mdash;Return images discovered within the last 30 days</li></ul>|String|  
