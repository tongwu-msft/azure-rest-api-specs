...
|<a name="contenttype" />Content-Type|Optional request header.<br /><br /> If you set the [modules](#modulesrequested) query parameter to RecognizedEntities, you may specify the binary of an image in the body of a POST request. If you specify the image in the body of a POST request, you must specify this header and set its value to multipart/form-data.<br /><br /> The maximum image size is 1 MB.|  
...
|<a name="freshness" />freshness|Filter images by the following discovery options:<br /><ul><li>Day&mdash;Return images discovered by Bing within the last 24 hours</li><li>Week&mdash;Return images discovered by Bing within the last 7 days</li><li>Month&mdash;Return images discovered by Bing within the last 30 days</li><li>Year&mdash;Return images discovered within the last year</li><li>2017-06-015..2018-06-15&mdash;Return images discovered within the specified range of dates</li></ul>|String|  
