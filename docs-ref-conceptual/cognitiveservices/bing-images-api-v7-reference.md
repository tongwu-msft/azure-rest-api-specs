...
|<a name="freshness" />freshness|Filter images by the following discovery options:<br /><ul><li>Day&mdash;Return images discovered by Bing within the last 24 hours</li><li>Week&mdash;Return images discovered by Bing within the last 7 days</li><li>Month&mdash;Return images discovered by Bing within the last 30 days</li><li>Year&mdash;Return images discovered within the last year</li>></ul>|String|  
