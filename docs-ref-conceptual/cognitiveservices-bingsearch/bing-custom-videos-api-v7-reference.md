...
|<a name="query" />q|The user's search query string. The query string cannot be empty.<br /><br />**NOTE:** The query string must not contain [Bing Advanced Operators](http://help.bing.microsoft.com/#apex/18/en-US/10001/-1). Including them may adversely affect the custom search experience.|String|Yes|  
