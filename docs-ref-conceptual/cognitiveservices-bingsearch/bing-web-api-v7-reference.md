...
|<a name="query" />q|The user's search query term. The term may not be empty.<br /><br /> The term may contain [Bing Advanced Operators](http://help.bing.microsoft.com/#apex/18/en-US/10001/-1). For example, to limit results to a specific domain, use the **site:** operator.|String|Yes|  
