...
|<a name="query" />q|The user's search query string. The query string may not be empty.<br /><br /> The query string may contain [Bing Advanced Operators](https://msdn.microsoft.com/library/ff795620.aspx). For example, to limit results to a specific domain, use the [site:](https://msdn.microsoft.com/library/ff795613.aspx) operator.|String|Yes|  
