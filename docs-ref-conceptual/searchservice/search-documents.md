...
> [!NOTE]  
>  Scoring statistics will always be calculated locally for terms that use [fuzzy search ('~')](https://docs.microsoft.com/en-us/azure/search/search-query-fuzzy#how-to-use-fuzzy-search). 
