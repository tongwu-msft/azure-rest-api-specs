...
| highlightPreTag | string | Optional. Defaults to `"</em>"`. A string tag that is prepends to hit highlights. Must be set with highlightPostTag. Reserved characters in URL must be percent-encoded (for example, %23 instead of #).  |
