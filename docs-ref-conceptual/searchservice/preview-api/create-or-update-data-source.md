...
| api-version | Required. The current version is `api-version=2020-06-30`. See [API versions](../search-service-api-versions.md) for available versions.|
...
You can get the `api-key` from your service dashboard in the Azure portal. For more information, see [Find existing keys](/search/search-security-api-keys#find-existing-keys).  
...
+ [Indexers overview](/search/search-indexer-overview)
+ [Creating indexers](/search/search-howto-create-indexers)
