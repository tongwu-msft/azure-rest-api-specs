...
| api-version | Set to `api-version=2020-06-30-Preview` (required). For **Search Documents**, the api-version is always specified as a URI parameter for both GET and POST. |
