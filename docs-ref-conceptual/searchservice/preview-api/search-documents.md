...
> [!Important]
> This preview API adds a **featuresMode** query parameter that can report on per-field term frequency, per-field similarity score, and per-field number of unique matches.
