...
| --------- | -------- | -------------------- | -------------------- |
| api-doc   | overwrite files (*.md) | content devs | Files containing the [overwrites](add-and-stage-overwrites.md) for REST operation and parameter `summary` and `description` fields. |
