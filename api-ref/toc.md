...
## [Application Gateway REST](../documentation/network/AppGateway/application-gateway-rest.md)
### [Operations on Application Gateway](../documentation/network/AppGateway/operations-on-application-gateway.md)
#### [Create or update an application gateway](../documentation/network/AppGateway/create-or-update-an-application-gateway.md)
#### [Get Application Gateway](../documentation/network/AppGateway/get-application-gateway.md)
#### [List application gateways (GET)](../documentation/network/AppGateway/list-application-gateways--get-.md)
#### [Delete Application Gateway (DELETE)](../documentation/network/AppGateway/delete-application-gateway--delete-.md)
#### [Start Application Gateway](../documentation/network/AppGateway/start-application-gateway.md)
#### [Stop Application Gateway](../documentation/network/AppGateway/stop-application-gateway.md)
## [ExpressRoute REST](../documentation/network/ExpressRoute/expressroute-rest.md)
### [Operations on ExpressRoute Service Providers](../documentation/network/ExpressRoute/operations-on-expressroute-service-providers.md)
#### [List Express Route Service Providers](../documentation/network/ExpressRoute/list-express-route-service-providers.md)
### [Operations on ExpressRoute Circuits](../documentation/network/ExpressRoute/operations-on-expressroute-circuits.md)
#### [Create or update an ExpressRoute Circuit](../documentation/network/ExpressRoute/create-or-update-an-expressroute-circuit.md)
#### [List ExpressRoute Circuit](../documentation/network/ExpressRoute/list-expressroute-circuit.md)
#### [Get ExpressRoute Circuit](../documentation/network/ExpressRoute/get-expressroute-circuit.md)
#### [Delete ExpressRoute Circuit](../documentation/network/ExpressRoute/delete-expressroute-circuit.md)
### [Operations on ExpressRoute BGP Peering](../documentation/network/ExpressRoute/operations-on-expressroute-bgp-peering.md)
#### [Create or update an ExpressRoute Circuit BGP Peering](../documentation/network/ExpressRoute/create-or-update-an-expressroute-circuit-bgp-peering.md)
#### [List ExpressRoute Circuit BGP Peering](../documentation/network/ExpressRoute/list-expressroute-circuit-bgp-peering.md)
#### [Get ExpressRoute Circuit BGP Peering](../documentation/network/ExpressRoute/get-expressroute-circuit-bgp-peering.md)
#### [Delete ExpressRoute Circuit BGP Peering](../documentation/network/ExpressRoute/delete-expressroute-circuit-bgp-peering.md)
## [Load Balancers REST](../documentation/network/LoadBalancers/load-balancers-rest.md)
### [Load balancer](../documentation/network/LoadBalancers/load-balancer.md)
#### [Create or update a load balancer](../documentation/network/LoadBalancers/create-or-update-a-load-balancer.md)
#### [Delete a load balancer](../documentation/network/LoadBalancers/delete-a-load-balancer.md)
#### [Get information about a load balancer ](../documentation/network/LoadBalancers/get-information-about-a-load-balancer .md)
#### [List load balancers within a resource group](../documentation/network/LoadBalancers/list-load-balancers-within-a-resource-group.md)
#### [List load balancers within a subscription](../documentation/network/LoadBalancers/list-load-balancers-within-a-subscription.md)
### [Load balancer inbound NAT rules](../documentation/network/LoadBalancers/load-balancer-inbound-nat-rules.md)
#### [Create or update a load balancer inbound NAT rule](../documentation/network/LoadBalancers/create-or-update-a-load-balancer-inbound-nat-rule.md)
#### [List inbound NAT rules of a load balancer](../documentation/network/LoadBalancers/list-inbound-nat-rules-of-a-load-balancer.md)
#### [Get information about a load balancer inbound NAT rule](../documentation/network/LoadBalancers/get-information-about-a-load-balancer-inbound-nat-rule.md)
#### [Delete a load balancer inbound NAT rule](../documentation/network/LoadBalancers/delete-a-load-balancer-inbound-nat-rule.md)
## [Azure Network Gateway REST API Reference](../documentation/network/networkgateway/azure-network-gateway-rest-api-reference.md)
### [Connections](../documentation/network/networkgateway/connections.md)
#### [Create or update a connection](../documentation/network/networkgateway/create-or-update-a-connection.md)
#### [Delete a connection ](../documentation/network/networkgateway/delete-a-connection .md)
#### [Get information about a connection ](../documentation/network/networkgateway/get-information-about-a-connection .md)
#### [Get the shared key for a connection ](../documentation/network/networkgateway/get-the-shared-key-for-a-connection .md)
#### [List all of the connections for a virtual network gateway ](../documentation/network/networkgateway/list-all-of-the-connections-for-a-virtual-network-gateway .md)
#### [Reset the shared key of a connection ](../documentation/network/networkgateway/reset-the-shared-key-of-a-connection .md)
#### [Set the shared key of a connection ](../documentation/network/networkgateway/set-the-shared-key-of-a-connection .md)
### [Local Network Gateways ](../documentation/network/networkgateway/local-network-gateways .md)
#### [Create or update a local network gateway ](../documentation/network/networkgateway/create-or-update-a-local-network-gateway .md)
#### [Delete a local network gateway](../documentation/network/networkgateway/delete-a-local-network-gateway.md)
#### [Get a VPN device configuration script](../documentation/network/networkgateway/get-a-vpn-device-configuration-script.md)
#### [List all of the local network gateways](../documentation/network/networkgateway/list-all-of-the-local-network-gateways.md)
#### [Get information about a local network gateway](../documentation/network/networkgateway/get-information-about-a-local-network-gateway.md)
### [Virtual Network Gateways](../documentation/network/networkgateway/virtual-network-gateways.md)
#### [Create or update a virtual network gateway](../documentation/network/networkgateway/create-or-update-a-virtual-network-gateway.md)
#### [Get information about a virtual network gateway](../documentation/network/networkgateway/get-information-about-a-virtual-network-gateway.md)
#### [List all of the virtual network gateways](../documentation/network/networkgateway/list-all-of-the-virtual-network-gateways.md)
#### [Delete a virtual network gateway](../documentation/network/networkgateway/delete-a-virtual-network-gateway.md)
...
### [Public IP Addresses](../documentation/network/NetworkREST/public-ip-addresses.md)
...
### [Routes](../documentation/network/NetworkREST/routes.md)
...
### [Status and Error Codes2](../documentation/storageservices/fileservices/status-and-error-codes2.md)
...
##### [List Containers2](../documentation/storageservices/fileservices/list-containers2.md)
...
##### [Delete Message2](../documentation/storageservices/fileservices/delete-message2.md)
...
##### [Update Entity2](../documentation/storageservices/fileservices/update-entity2.md)
...
##### [Delete File2](../documentation/storageservices/fileservices/delete-file2.md)
...
#### [List Locations2](../documentation/storageservices/importexport/list-locations2.md)
#### [List Storage Accounts2](../documentation/storageservices/importexport/list-storage-accounts2.md)
