...
Once you have access to an Azure AD tenant, its helpful to consider the following concepts before you register your client:
...
2. Create the Authorization request header and body
